# MCP Guardrails | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/mcp_guardrail
- Final URL: https://docs.litellm.ai/docs/mcp_guardrail
- Canonical URL: https://docs.litellm.ai/docs/mcp_guardrail
- Fetched at: 2026-06-23T14:24:36Z
...
Credit card number will be blocked (request rejected)
Email address will be masked (e.g., replaced with <EMAIL_ADDRESS> )
