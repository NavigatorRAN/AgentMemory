# File Search in the Responses API | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/tutorials/file_search_responses_api
- Final URL: https://docs.litellm.ai/docs/tutorials/file_search_responses_api
- Canonical URL: https://docs.litellm.ai/docs/tutorials/file_search_responses_api
- Fetched at: 2026-06-23T14:34:06Z
...
Behavior Matrix ​
Path SDK model Proxy model Behavior Native passthrough openai/gpt-4.1 gpt-4.1 Provider executes native file_search Emulated fallback anthropic/claude-sonnet-4-5 claude-sonnet LiteLLM converts to function tool and synthesizes OpenAI-format output
...
What to check next ​
File Search reference in Responses API docs — full API reference
Vector Store management — create and manage vector stores
Managed vector stores — provider-specific setup
What this is
Usage
1. Setup config.yaml
2. Start the proxy
