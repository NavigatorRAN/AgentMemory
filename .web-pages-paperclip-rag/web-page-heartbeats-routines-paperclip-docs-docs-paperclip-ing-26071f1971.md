# Heartbeats & Routines | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/guides/projects-workflow/routines
- Final URL: https://docs.paperclip.ing/guides/projects-workflow/routines/
- Canonical URL: https://docs.paperclip.ing/guides/projects-workflow/routines
- Fetched at: 2026-06-23T13:38:09Z
- Content type: text/html; charset=utf-8

## Description

When you first hire a few agents, it's tempting to give each one a timer — "wake up every few minutes and see if there's anything to do." It feels proactive. In practice, it's the
...
Run heartbeat every N sec — only visible when the interval is on. If you need a timer at all, prefer minutes or hours, not seconds.
...
Give it a title and a short description of what the task should do
Add a trigger. For scheduled work, pick Schedule and enter a cron expression — the default 0 10 * * * fires every day at 10:00 in your local timezone
Assign it to the agent that should handle the work
Save and enable it
...
Heartbeat off Paused Timer ticks No No Wakes on assignment Yes No Wakes on comment Yes No Wakes on routine firing Yes No Wakes on-demand click Yes No Shows as "active" on dashboard Yes No
