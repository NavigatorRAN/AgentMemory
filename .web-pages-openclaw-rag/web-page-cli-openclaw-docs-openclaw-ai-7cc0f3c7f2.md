...
- Requested URL: https://docs.openclaw.ai/clawhub/cli
- Final URL: https://docs.openclaw.ai/clawhub/cli
- Canonical URL: https://docs.openclaw.ai/clawhub/cli
- Fetched at: 2026-06-23T14:36:55Z
- Content type: text/html; charset=utf-8

## Description

CLI reference: commands, flags, config, and lockfile behavior.
...
Then verify it:
bash Copy code clawhub -- help clawhub login clawhub whoami
Global flags
...
firewalls).
Example:
bash Copy code export HTTPS_PROXY=http://proxy.example.com:3128 export NO_PROXY=localhost,127.0.0.1 clawhub search "my query"
...
bash Copy code clawhub skill publish ./my-skill --dry-run clawhub skill publish ./my-skill clawhub skill publish ./my-skill --version 2.0.0 GitHub Actions
ClawHub's reusable
skill-publish.yml
...
bash Copy code clawhub sync --all --dry-run clawhub sync --all clawhub sync --root ./skills --owner openclaw --bump minor
scan --slug <slug>
...
bash Copy code clawhub scan --slug gifgrep clawhub scan --slug gifgrep --version 1.2.3 clawhub scan --slug gifgrep --update --output report.zip
scan download <name>
...
bash Copy code clawhub scan download gifgrep --version 1.2.3 clawhub scan download @scope/demo --version 2.0.0 --kind plugin --output report.zip GitHub Actions
...
--json
Examples:
bash Copy code clawhub package explore --family code-plugin clawhub package explore --family code-plugin --os darwin --requires-desktop clawhub package explore --family code-plugin --artifact-kind npm-pack clawhub package explore --npm-mirror clawhub package explore episodic-claw --family code-plugin
...
bash Copy code clawhub package download @openclaw/example-plugin --tag latest clawhub package download @openclaw/example-plugin --version 1.2.3 -o artifacts/
package verify <file>
...
bash Copy code clawhub package verify ./example-plugin-1.2.3.tgz --package @openclaw/example-plugin --version 1.2.3 clawhub package verify ./example-plugin-1.2.3.tgz --sha256 <hex>
...
bash Copy code clawhub package validate ./example-plugin
If validation reports a package, manifest, SDK import, or artifact finding, see
Plugin validation fixes , then rerun the command.
package delete <name>
...
bash Copy code clawhub package delete @openclaw/example-plugin -- yes clawhub package delete @openclaw/example-plugin --version 1.2.3 -- yes
...
bash Copy code clawhub package undelete @openclaw/example-plugin -- yes
...
bash Copy code clawhub package transfer @openclaw/example-plugin --to openclaw
package report
...
bash Copy code clawhub package report @openclaw/example-plugin --version 1.2.3 --reason "suspicious native payload"
...
bash Copy code clawhub package moderation-status @openclaw/example-plugin
...
and scan state.
bash Copy code clawhub package readiness @openclaw/example-plugin
...
blockers.
bash Copy code clawhub package migration-status @openclaw/example-plugin
...
bash Copy code clawhub publisher create opik --display-name "Opik"
...
bash Copy code clawhub package publish ./plugin.tgz --owner openclaw Recommended local flow
Use --dry-run first so you can confirm the resolved package metadata and
source attribution before creating a live release:
bash Copy code npm pack clawhub package publish ./my-plugin-1.2.3.tgz --family code-plugin --dry-run clawhub package publish ./my-plugin-1.2.3.tgz --family code-plugin Local folder flow
For code plugins, folder publish builds and uploads a ClawPack artifact from
the package folder:
bash Copy code clawhub package publish ./my-plugin --family code-plugin --dry-run clawhub package publish ./my-plugin --family code-plugin Minimal package.json for --family code-plugin
...
json Copy code { "name" : "@myorg/openclaw-my-plugin" , "version" : "1.0.0" , "type" : "module" , "openclaw" : { "extensions" : [ "./index.ts" ] , "compat" : { "pluginApi" : ">=2026.3.24-beta.2" } , "build" : { "openclawVersion" : "2026.3.24-beta.2" } } }
Required fields:
...
bash Copy code clawhub package trusted-publisher get @openclaw/example-plugin
...
bash Copy code clawhub package trusted-publisher set @openclaw/example-plugin \ --repository openclaw/example-plugin \ --workflow-filename package-publish.yml \ --environment release
...
set again.
bash Copy code clawhub package trusted-publisher delete @openclaw/example-plugin
Install telemetry
