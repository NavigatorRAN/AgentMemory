# Advisor Tool | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/completion/anthropic_advisor_tool
- Final URL: https://docs.litellm.ai/docs/completion/anthropic_advisor_tool
- Canonical URL: https://docs.litellm.ai/docs/completion/anthropic_advisor_tool
- Fetched at: 2026-06-23T14:23:02Z
...
Supported Providers ​
Provider Chat Completions API Messages API Notes Anthropic API ✅ ✅ Native — runs server-side OpenAI / Azure OpenAI ✅ ✅ LiteLLM orchestration loop Amazon Bedrock ✅ ✅ LiteLLM orchestration loop Google Vertex AI ✅ ✅ LiteLLM orchestration loop Groq / Mistral / others ✅ ✅ LiteLLM orchestration loop
...
Executor Advisor claude-haiku-4-5-20251001 claude-opus-4-6 claude-sonnet-4-6 claude-opus-4-6 claude-opus-4-6 claude-opus-4-6
Chat Completions API ​
SDK Usage ​
Basic Example ​
Advisor Tool — litellm.completion()
import litellm
...
Advisor Tool with max_uses and caching
...
Messages API ​
Advisor Tool — litellm.anthropic.messages
import asyncio
async def main ( ) :
response = await litellm . anthropic . messages . acreate (
print ( response )
asyncio . run ( main ( ) )
Messages API Streaming with Advisor Tool
import json
...
Advisor Tool via AI Gateway (Anthropic SDK)
import anthropic
...
Advisor Tool with OpenAI executor
...
Usage with advisor sub-inference
"usage" : {
"input_tokens" : 412 ,
"output_tokens" : 531 ,
"iterations" : [
