...
- Requested URL: https://developers.openai.com/codex/plugins/build
- Final URL: https://developers.openai.com/codex/plugins/build
- Canonical URL: https://developers.openai.com/codex/plugins/build
- Fetched at: 2026-06-23T14:12:46Z
...
plugins in Codex, see Plugins . If you are still iterating on
...
codex plugin marketplace list codex plugin marketplace upgrade codex plugin marketplace upgrade marketplace-name codex plugin marketplace remove marketplace-name
...
--- name : hello description : Greet the user with a friendly message. --- Greet the user warmly and ask how you can help.
Add the plugin to a marketplace. Use @plugin-creator to generate one, or
follow Build your own curated plugin list
...
mkdir -p ./plugins cp -R /absolute/path/to/my-plugin ./plugins/my-plugin
...
relative path:
{ "name" : "local-repo" , "plugins" : [ { "name" : "my-plugin" , "source" : { "source" : "local" , "path" : "./plugins/my-plugin" }, "policy" : { "installation" : "AVAILABLE" , "authentication" : "ON_INSTALL" }, "category" : "Productivity" } ] }
...
mkdir -p ~/.codex/plugins cp -R /absolute/path/to/my-plugin ~/.codex/plugins/my-plugin
...
{ "name" : "remote-helper" , "source" : { "source" : "git-subdir" , "url" : "https://github.com/example/codex-plugins.git" , "path" : "./plugins/remote-helper" , "ref" : "main" }, "policy" : { "installation" : "AVAILABLE" , "authentication" : "ON_INSTALL" }, "category" : "Productivity" }
...
[ plugins . "my-plugin" . mcp_servers . docs ] enabled = true default_tools_approval_mode = "prompt" enabled_tools = [ "search" ] [ plugins . "my-plugin" . mcp_servers . docs . tools . search ] approval_mode = "approve"
...
hooks objects.
{ "name" : "repo-policy" , "hooks" : [ "./hooks/session.json" , "./hooks/tools.json" ] }
...
Hooks for supported events, inputs, outputs, trust review, and
current limitations.
