# Minecraft Modpack Server — Host modded Minecraft servers (CurseForge, Modrinth) | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/gaming/gaming-minecraft-modpack-server
- Fetched at: 2026-06-23T14:19:40Z
...
Host modded Minecraft servers (CurseForge, Modrinth).
Skill metadata ​
Source Optional — install with hermes skills install official/gaming/minecraft-modpack-server Path optional-skills/gaming/minecraft-modpack-server Platforms linux, macos
