# Arxiv — Search arXiv papers by keyword, author, category, or ID | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-arxiv
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-arxiv
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-arxiv
- Fetched at: 2026-06-23T14:18:40Z
...
Search arXiv papers by keyword, author, category, or ID.
Skill metadata ​
Source Bundled (installed by default) Path skills/research/arxiv Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags Research , Arxiv , Papers , Academic , Science , API Related skills ocr-and-documents
...
Rate Limits ​
API Rate Auth arXiv ~1 req / 3 seconds None needed Semantic Scholar 1 req / second None (100/sec with API key)
Notes ​
