# MCP Config Reference | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference
- Final URL: https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference
- Canonical URL: https://hermes-agent.nousresearch.com/docs/reference/mcp-config-reference
- Fetched at: 2026-06-23T14:15:34Z
