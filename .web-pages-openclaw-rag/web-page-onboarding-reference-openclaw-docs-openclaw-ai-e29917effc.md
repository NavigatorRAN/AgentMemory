...
- Requested URL: https://docs.openclaw.ai/reference/wizard
- Final URL: https://docs.openclaw.ai/reference/wizard
- Canonical URL: https://docs.openclaw.ai/reference/wizard
- Fetched at: 2026-06-23T14:57:01Z
...
bash Copy code openclaw onboard --non-interactive \ --mode local \ --auth-choice apiKey \ --anthropic-api-key " $ANTHROPIC_API_KEY " \ --gateway-port 18789 \ --gateway-bind loopback \ --install-daemon \ --daemon-runtime node \ --skip-skills
Add --json for a machine-readable summary.
Gateway token SecretRef in non-interactive mode:
bash Copy code export OPENCLAW_GATEWAY_TOKEN= "your-token" openclaw onboard --non-interactive \ --mode local \ --auth-choice skip \ --gateway-auth token \ --gateway-token-ref-env OPENCLAW_GATEWAY_TOKEN
