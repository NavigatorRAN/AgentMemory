...
- Requested URL: https://docs.openclaw.ai/channels/clickclack
- Final URL: https://docs.openclaw.ai/channels/clickclack
- Canonical URL: https://docs.openclaw.ai/channels/clickclack
- Fetched at: 2026-06-23T14:36:02Z
...
bash Copy code clickclack admin bot create \ --workspace <workspace_id_or_slug> \ --name "OpenClaw" \ --handle openclaw \ --scopes bot:write \ --plain
For a user-owned bot, add --owner <user_id> .
Configure OpenClaw:
json5 Copy code { plugins : { entries : { clickclack : { llm : { allowAgentIdOverride : true , }, }, }, }, channels : { clickclack : { enabled : true , baseUrl : "https://app.clickclack.chat" , token : { source : "env" , provider : "default" , id : "CLICKCLACK_BOT_TOKEN" }, workspace : "default" , defaultTo : "channel:general" , agentId : "clickclack-bot" , replyMode : "model" , }, }, }
Then run:
bash Copy code export CLICKCLACK_BOT_TOKEN= "ccb_..." openclaw gateway
...
Examples:
bash Copy code openclaw message send --channel clickclack --target channel:general --message "hello" openclaw message send --channel clickclack --target dm:usr_123 --message "hello" openclaw message send --channel clickclack --target thread:msg_123 --message "following up"
Permissions
