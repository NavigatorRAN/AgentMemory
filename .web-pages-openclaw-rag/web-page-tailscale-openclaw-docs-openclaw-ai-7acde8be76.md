...
- Requested URL: https://docs.openclaw.ai/gateway/tailscale
- Final URL: https://docs.openclaw.ai/gateway/tailscale
- Canonical URL: https://docs.openclaw.ai/gateway/tailscale
- Fetched at: 2026-06-23T14:44:12Z
...
json5 Copy code { gateway : { bind : "loopback" , tailscale : { mode : "serve" , serviceName : "svc:openclaw" }, }, }
...
json5 Copy code { gateway : { bind : "tailnet" , auth : { mode : "token" , token : "your-token" }, }, }
...
json5 Copy code { gateway : { bind : "loopback" , tailscale : { mode : "funnel" }, auth : { mode : "password" , password : "replace-me" }, }, }
Prefer OPENCLAW_GATEWAY_PASSWORD over committing a password to disk.
CLI examples
bash Copy code openclaw gateway --tailscale serve openclaw gateway --tailscale funnel --auth password
Notes
