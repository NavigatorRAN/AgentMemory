...
- Requested URL: https://docs.openclaw.ai/concepts/memory-qmd
- Final URL: https://docs.openclaw.ai/concepts/memory-qmd
- Canonical URL: https://docs.openclaw.ai/concepts/memory-qmd
- Fetched at: 2026-06-23T14:38:50Z
...
QMD is a local-first search sidecar that runs
...
Enable
json5 Copy code { memory : { backend : "qmd" , }, }
...
bash Copy code qmd search "router notes" --json -n 10 -c memory-root-main -c memory-dir-main
...
bash Copy code qmd -- help | grep -i collection
...
bash Copy code export QMD_EMBED_MODEL= "hf:Qwen/Qwen3-Embedding-0.6B-GGUF/Qwen3-Embedding-0.6B-Q8_0.gguf" export QMD_RERANK_MODEL= "/absolute/path/to/reranker.gguf" export QMD_GENERATE_MODEL= "/absolute/path/to/generator.gguf"
...
json5 Copy code { memory : { backend : "qmd" , qmd : { paths : [{ name : "docs" , path : "~/notes" , pattern : "**/*.md" }], }, }, }
...
json5 Copy code { memory : { backend : "qmd" , qmd : { sessions : { enabled : true }, }, }, }
...
json5 Copy code { memory : { backend : "qmd" , qmd : { command : "/absolute/path/to/qmd" , }, }, }
