...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-cli
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-cli
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-cli
- Fetched at: 2026-06-23T14:19:23Z
- Content type: text/html; charset=utf-8

## Description

Run 150+ AI apps via inference
...
Skill metadata ​
Source Optional — install with hermes skills install official/devops/cli Path optional-skills/devops/cli Version 1.0.0 Author okaris License MIT Platforms linux, macos, windows Tags AI , image-generation , video , LLM , search , inference , FLUX , Veo , Claude
...
Pitfalls ​
Never guess app IDs — always run infsh app list --search <term> first. App IDs change and new apps are added frequently.
Always use --json — raw output is hard to parse. The --json flag gives structured output with URLs.
Check authentication — if commands fail with auth errors, run infsh login or verify INFSH_API_KEY is set.
Long-running apps — video generation can take 30-120 seconds. The terminal tool timeout should be sufficient, but warn the user it may take a moment.
Input format — the --input flag takes a JSON string. Make sure to properly escape quotes.
Reference Docs ​
