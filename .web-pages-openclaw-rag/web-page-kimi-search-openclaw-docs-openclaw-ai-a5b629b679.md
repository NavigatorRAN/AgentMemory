...
- Requested URL: https://docs.openclaw.ai/tools/kimi-search
- Final URL: https://docs.openclaw.ai/tools/kimi-search
- Canonical URL: https://docs.openclaw.ai/tools/kimi-search
- Fetched at: 2026-06-23T14:57:54Z
...
Config
json5 Copy code { plugins : { entries : { moonshot : { config : { webSearch : { apiKey : "sk-..." , // optional if KIMI_API_KEY or MOONSHOT_API_KEY is set baseUrl : "https://api.moonshot.ai/v1" , model : "kimi-k2.6" , }, }, }, }, }, tools : { web : { search : { provider : "kimi" , }, }, }, }
