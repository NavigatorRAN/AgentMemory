...
- Requested URL: https://docs.openclaw.ai/install/hetzner
- Final URL: https://docs.openclaw.ai/install/hetzner
- Canonical URL: https://docs.openclaw.ai/install/hetzner
- Fetched at: 2026-06-23T14:44:45Z
...
Connect as root:
bash Copy code ssh root@YOUR_VPS_IP
This guide assumes the VPS is stateful.
Do not treat it as disposable infrastructure.
Install Docker (on the VPS)
bash Copy code apt-get update apt-get install -y git curl ca-certificates curl -fsSL https://get.docker.com | sh
Verify:
...
bash Copy code mkdir -p /root/.openclaw/workspace # Set ownership to the container user (uid 1000): chown -R 1000:1000 /root/.openclaw
Configure environment variables
Create .env in the repository root.
bash Copy code OPENCLAW_IMAGE=openclaw:latest OPENCLAW_GATEWAY_TOKEN= OPENCLAW_GATEWAY_BIND=lan OPENCLAW_GATEWAY_PORT=18789 OPENCLAW_CONFIG_DIR=/root/.openclaw OPENCLAW_WORKSPACE_DIR=/root/.openclaw/workspace GOG_KEYRING_PASSWORD= XDG_CONFIG_HOME=/home/node/.openclaw
...
Code Copy code AllowTcpForwarding local
...
bash Copy code ssh -N -L 18789:127.0.0.1:18789 root@YOUR_VPS_IP
Open:
