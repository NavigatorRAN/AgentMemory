...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-songsee
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-songsee
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-songsee
- Fetched at: 2026-06-23T14:18:18Z
...
Audio spectrograms/features (mel, chroma, MFCC) via CLI.
Skill metadata ​
Source Bundled (installed by default) Path skills/media/songsee Version 1.0.0 Author community License MIT Platforms linux, macos, windows Tags Audio , Visualization , Spectrogram , Music , Analysis
