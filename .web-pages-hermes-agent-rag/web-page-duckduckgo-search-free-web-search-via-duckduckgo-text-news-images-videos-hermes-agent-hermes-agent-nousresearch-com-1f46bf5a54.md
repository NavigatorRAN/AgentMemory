# Duckduckgo Search — Free web search via DuckDuckGo — text, news, images, videos | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-duckduckgo-search
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-duckduckgo-search
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-duckduckgo-search
- Fetched at: 2026-06-23T14:20:41Z
- Content type: text/html; charset=utf-8

## Description

Free web search via DuckDuckGo — text, news, images, videos
...
Skill metadata ​
Source Optional — install with hermes skills install official/research/duckduckgo-search Path optional-skills/research/duckduckgo-search Version 1.3.0 Author gamedevCloudy License MIT Platforms linux, macos, windows Tags search , duckduckgo , web-search , free , fallback Related skills arxiv
...
Decision tree:
If ddgs CLI is installed, prefer terminal + ddgs
If ddgs CLI is missing, do not assume execute_code can import ddgs
If the user wants DuckDuckGo specifically, install ddgs first in the relevant environment
...
CLI Flags ​
Flag Description Example -q Query — required -q "search terms" -m Max results -m 5 -r Region -r us-en -t Time limit -t w (week) -s Safe search -s off -o Output format -o json
...
Quick Reference ​
Method Use When Key Fields text() General research, companies title, href, body news() Current events, updates date, title, source, body, url images() Visuals, diagrams title, image, thumbnail, url videos() Tutorials, demos title, content, duration, provider
