# MCP - AWS SigV4 Auth | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/mcp_aws_sigv4
- Final URL: https://docs.litellm.ai/docs/mcp_aws_sigv4
- Canonical URL: https://docs.litellm.ai/docs/mcp_aws_sigv4
- Fetched at: 2026-06-23T14:24:32Z
...
LiteLLM UI
config.yaml
Navigate to MCP Servers and click Add New MCP Server
Set the transport to Streamable HTTP
Select AWS SigV4 as the authentication type
...
See MCP REST API for tool naming, server_id formats, and common mistakes.
Config Reference ​
...
For every outgoing MCP request, the auth handler computes a SHA-256 hash of the request body
It creates a SigV4 signature using your AWS credentials, the request URL, headers, and body hash
The signed Authorization and x-amz-date headers are added to the request
AWS validates the signature and processes the MCP request
...
config.yaml with AssumeRole + explicit source keys
