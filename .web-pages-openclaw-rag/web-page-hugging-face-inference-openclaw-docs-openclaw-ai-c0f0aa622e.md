...
- Requested URL: https://docs.openclaw.ai/providers/huggingface
- Final URL: https://docs.openclaw.ai/providers/huggingface
- Canonical URL: https://docs.openclaw.ai/providers/huggingface
- Fetched at: 2026-06-23T14:55:25Z
...
bash Copy code openclaw onboard --auth-choice huggingface-api-key
...
json5 Copy code { agents : { defaults : { model : { primary : "huggingface/deepseek-ai/DeepSeek-R1" }, }, }, }
Verify the model is available
bash Copy code openclaw models list --provider huggingface
Non-interactive setup
bash Copy code openclaw onboard --non-interactive \ --mode local \ --auth-choice huggingface-api-key \ --huggingface-api-key " $HF_TOKEN "
...
bash Copy code GET https://router.huggingface.co/v1/models
...
json5 Copy code { agents : { defaults : { models : { "huggingface/deepseek-ai/DeepSeek-R1" : { alias : "DeepSeek R1 (fast)" }, "huggingface/deepseek-ai/DeepSeek-R1:cheapest" : { alias : "DeepSeek R1 (cheap)" }, }, }, }, }
