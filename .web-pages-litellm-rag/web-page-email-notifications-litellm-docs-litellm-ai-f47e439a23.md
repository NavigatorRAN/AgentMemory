...
- Requested URL: https://docs.litellm.ai/docs/proxy/email
- Final URL: https://docs.litellm.ai/docs/proxy/email
- Canonical URL: https://docs.litellm.ai/docs/proxy/email
- Fetched at: 2026-06-23T14:30:11Z
...
Category Details Supported Events • User added as a user on LiteLLM Proxy
...
< p style = ' font-size : 12 px ; color : #666 ; ' >
...
Behavior:
Setting Key Created Email Key Rotated Email true (default) Shows actual sk-xxxxx key Shows actual sk-xxxxx key false Shows placeholder message Shows placeholder message
