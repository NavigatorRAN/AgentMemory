# Call Gemini Realtime API with Audio Input/Output | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/tutorials/gemini_realtime_with_audio
- Final URL: https://docs.litellm.ai/docs/tutorials/gemini_realtime_with_audio
- Canonical URL: https://docs.litellm.ai/docs/tutorials/gemini_realtime_with_audio
- Fetched at: 2026-06-23T14:34:10Z
