# Add Model Pricing & Context Window | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/provider_registration/add_model_pricing
- Final URL: https://docs.litellm.ai/docs/provider_registration/add_model_pricing
- Canonical URL: https://docs.litellm.ai/docs/provider_registration/add_model_pricing
- Fetched at: 2026-06-23T14:26:37Z
...
info
This is different from model_alias_map , which is a runtime SDK/proxy feature for mapping user-facing model names to LiteLLM model identifiers. The aliases field here is for the model cost JSON only — it avoids duplicate entries for models that share identical pricing and capabilities.
Sample Spec
Examples
Using Aliases
🚅
