# Heartmula — HeartMuLa: Suno-like song generation from lyrics + tags | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-heartmula
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-heartmula
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-heartmula
- Fetched at: 2026-06-23T14:18:17Z
...
HeartMuLa: Suno-like song generation from lyrics + tags.
Skill metadata ​
Source Bundled (installed by default) Path skills/media/heartmula Version 1.0.0 Platforms linux, macos, windows Tags music , audio , generation , ai , heartmula , heartcodec , lyrics , songs Related skills audiocraft
...
[Outro]
Key Parameters ​
Parameter Default Description --max_audio_length_ms 240000 Max length in ms (240s = 4 min) --topk 50 Top-k sampling --temperature 1.0 Sampling temperature --cfg_scale 1.5 Classifier-free guidance scale --lazy_load false Load/unload models on demand (saves VRAM) --mula_dtype bfloat16 Dtype for HeartMuLa (bf16 recommended) --codec_dtype float32 Dtype for HeartCodec (fp32 recommended for quality)
Performance ​
