# Trust & Low-Trust Review | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/administration/trust-and-low-trust-review
- Final URL: https://docs.paperclip.ing/administration/trust-and-low-trust-review/
- Canonical URL: https://docs.paperclip.ing/administration/trust-and-low-trust-review
- Fetched at: 2026-06-23T13:37:39Z
- Content type: text/html; charset=utf-8

## Description

Some work in a Paperclip company is born from input you cannot vouch for: an untrusted pull request, an external ticket, a dependency diff, or output an agent generated from any of
...
It helps to read Execution Policy first — trust presets layer on top of the same execution-policy plumbing, and a low-trust run leans on the isolated workspace and sandbox mechanics described there.
...
Source Where it lives Agent the agent's permissions — trustPreset and authorizationPolicy.trustBoundary Project the project's executionWorkspacePolicy.authorizationPolicy Issue the issue's executionPolicy.authorizationPolicy Run the run's executionPolicy.authorizationPolicy
