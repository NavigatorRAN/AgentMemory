# Systematic Debugging — 4-phase root cause debugging: understand bugs before fixing | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-systematic-debugging
- Fetched at: 2026-06-23T14:18:57Z
...
4-phase root cause debugging: understand bugs before fixing.
Skill metadata ​
Source Bundled (installed by default) Path skills/software-development/systematic-debugging Version 1.1.0 Author Hermes Agent (adapted from obra/superpowers) License MIT Platforms linux, macos, windows Tags debugging , troubleshooting , problem-solving , root-cause , investigation Related skills test-driven-development , plan , subagent-driven-development
