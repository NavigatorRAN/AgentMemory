...
- Requested URL: https://docs.openclaw.ai/clawhub/publishing
- Final URL: https://docs.openclaw.ai/clawhub/publishing
- Canonical URL: https://docs.openclaw.ai/clawhub/publishing
- Fetched at: 2026-06-23T14:37:06Z
- Content type: text/html; charset=utf-8

## Description

How ClawHub publishing works for skills, plugins, owners, scopes, releases, and review.
...
folder:
bash Copy code clawhub login clawhub skill publish ./my-skill \ --slug my-skill \ --name "My Skill" \ --owner <owner>
...
yaml Copy code jobs: publish: uses: openclaw/clawhub/.github/workflows/skill-publish.yml@main with: owner: <owner> dry_run: false secrets: clawhub_token: ${{ secrets.CLAWHUB_TOKEN }}
...
text Copy code @owner/package-name
...
Publish the package once through normal manual or token-authenticated
...
A package manager sets the GitHub Actions trusted publisher config:
bash Copy code clawhub package trusted-publisher set @owner/package-name \ --repository owner/repo \ --workflow-filename package-publish.yml
...
bash Copy code clawhub package trusted-publisher get @owner/package-name clawhub package trusted-publisher delete @owner/package-name
...
publish:
text Copy code Package scope "@openclaw" must match selected owner "@vintageayu". Publish as "@openclaw" or rename this package to "@vintageayu/dronzer".
...
sh Copy code clawhub package transfer @opik/opik-openclaw --to opik
...
Org and Namespace Claims before filing.
