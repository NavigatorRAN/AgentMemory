...
final class RAGQueueExportTests: XCTestCase {
    func testExportBuilderCreatesMarkdownDocumentForCapture() {
        ...
        XCTAssertTrue(document.content.hasPrefix("---\n"))
        XCTAssertTrue(document.content.contains("collection: \"agentmemory\""))
        XCTAssertTrue(document.content.contains("source_type: \"video\""))
        XCTAssertTrue(document.content.contains("doc_type: \"agentmemory-capture\""))
        XCTAssertTrue(document.content.contains("language: \"en\""))
        XCTAssertTrue(document.content.contains("source_url: \"https://youtu.be/example\""))
        XCTAssertTrue(document.content.contains("content_hash: \""))
