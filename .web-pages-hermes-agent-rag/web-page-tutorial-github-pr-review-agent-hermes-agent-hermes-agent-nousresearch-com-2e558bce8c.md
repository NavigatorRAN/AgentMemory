...
- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/github-pr-review-agent
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/github-pr-review-agent
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/github-pr-review-agent
- Fetched at: 2026-06-23T14:15:02Z
...
Hermes will:
Execute gh pr diff to fetch the code changes
...
Schedule When 0 */2 * * * Every 2 hours 0 9,13,17 * * 1-5 Three times a day, weekdays only 0 9 * * 1 Weekly Monday morning roundup 30m Every 30 minutes (high-traffic repos)
...
Add the code-review skill (Step 3)
Teach Hermes your conventions via memory (Step 4)
