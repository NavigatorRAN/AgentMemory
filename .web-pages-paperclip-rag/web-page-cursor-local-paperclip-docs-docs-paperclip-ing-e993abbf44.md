# Cursor Local | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/reference/adapters/cursor-local
- Final URL: https://docs.paperclip.ing/reference/adapters/cursor-local/
- Canonical URL: https://docs.paperclip.ing/reference/adapters/cursor-local
- Fetched at: 2026-06-23T13:38:47Z
...
When Not To Use
You need webhook-style external invocation. Use OpenClaw Gateway or HTTP .
