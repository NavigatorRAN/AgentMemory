# Hermes Agent Skill Authoring — Author in-repo SKILL | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-hermes-agent-skill-authoring
- Fetched at: 2026-06-23T14:18:48Z
- Content type: text/html; charset=utf-8

## Description

Author in-repo SKILL
...
Skill metadata ​
Source Bundled (installed by default) Path skills/software-development/hermes-agent-skill-authoring Version 1.1.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags skills , authoring , hermes-agent , conventions , skill-md Related skills plan , requesting-code-review
