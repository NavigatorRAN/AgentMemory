# Anthropic Tool Input Examples | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/providers/anthropic_tool_input_examples
- Final URL: https://docs.litellm.ai/docs/providers/anthropic_tool_input_examples
- Canonical URL: https://docs.litellm.ai/docs/providers/anthropic_tool_input_examples
- Fetched at: 2026-06-23T14:26:46Z
...
LiteLLM detects the input_examples field in your tool definition
Beta header added automatically : The advanced-tool-use-2025-11-20 header is injected
Examples included in prompt : Anthropic includes the examples alongside your tool schema
Claude learns patterns : The model uses examples to understand proper tool usage
Better tool calls : Claude makes more accurate tool calls with correct parameter formats
Example Formats ​
...
Solution :
Check descriptions first : Ensure tool descriptions are detailed and clear
Review example quality : Make sure examples are realistic and diverse
Verify schema : Confirm examples actually match your schema
Add more variation : Include examples showing different use cases
Token usage too high ​
Problem : Input examples consuming too many tokens
Reduce example count : Use 2-3 examples instead of 5+
Simplify examples : Remove unnecessary fields from examples
Consider descriptions : If descriptions are clear, examples may not be needed
...
Related Features ​
Anthropic Tool Search - Dynamically discover and load tools on-demand
Anthropic Programmatic Tool Calling - Call tools from code execution
Anthropic Provider - General Anthropic provider documentation
When to Use Input Examples
Quick Start
How It Works
Example Formats
