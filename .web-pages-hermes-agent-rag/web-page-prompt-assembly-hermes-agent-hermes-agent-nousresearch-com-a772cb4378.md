...
- Requested URL: https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly
- Final URL: https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly
- Canonical URL: https://hermes-agent.nousresearch.com/docs/developer-guide/prompt-assembly
- Fetched at: 2026-06-23T14:14:37Z
...
Priority Files Search scope Notes 1 .hermes.md , HERMES.md CWD up to git root Hermes-native project config 2 AGENTS.md CWD only Common agent instruction file 3 CLAUDE.md CWD only Claude Code compatibility 4 .cursorrules , .cursor/rules/*.mdc CWD only Cursor compatibility
