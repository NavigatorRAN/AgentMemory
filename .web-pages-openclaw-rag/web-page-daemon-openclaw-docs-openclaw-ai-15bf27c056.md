...
- Requested URL: https://docs.openclaw.ai/cli/daemon
- Final URL: https://docs.openclaw.ai/cli/daemon
- Canonical URL: https://docs.openclaw.ai/cli/daemon
- Fetched at: 2026-06-23T14:37:30Z
...
Usage
bash Copy code openclaw daemon status openclaw daemon install openclaw daemon start openclaw daemon stop openclaw daemon restart openclaw daemon uninstall
Subcommands
...
If you intentionally run multiple gateways on one host, isolate ports, config/state, and workspaces; see /gateway#multiple-gateways-same-host .
