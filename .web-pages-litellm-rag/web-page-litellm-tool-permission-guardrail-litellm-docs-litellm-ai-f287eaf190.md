# LiteLLM Tool Permission Guardrail | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/tool_permission
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/tool_permission
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/tool_permission
- Fetched at: 2026-06-23T14:31:05Z
...
Provide a regex for the tool name (e.g., ^mcp__github_.*$ ).
Optionally add a regex for tool type (e.g., ^function$ ).
Pick Allow or Deny .
...
Only allow mail_mcp to mail @berri.ai addresses
