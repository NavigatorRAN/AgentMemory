...
- Requested URL: https://docs.openclaw.ai/plugins/memory-wiki
- Final URL: https://docs.openclaw.ai/plugins/memory-wiki
- Canonical URL: https://docs.openclaw.ai/plugins/memory-wiki
- Fetched at: 2026-06-23T14:50:26Z
...
Layer Owns Active memory plugin ( memory-core , QMD, Honcho, etc.) Recall, semantic search, promotion, dreaming, memory runtime memory-wiki Compiled wiki pages, provenance-rich syntheses, dashboards, wiki-specific search/get/apply
...
text Copy code <vault>/ AGENTS.md WIKI.md index.md inbox.md entities/ concepts/ syntheses/ sources/ reports/ _attachments/ _views/ .openclaw-wiki/
...
bash Copy code openclaw wiki okf import ./bundles/ga4
...
Turn on dashboards if you want stale/contradiction visibility.
Related docs
Memory Overview
CLI: memory
CLI: wiki
