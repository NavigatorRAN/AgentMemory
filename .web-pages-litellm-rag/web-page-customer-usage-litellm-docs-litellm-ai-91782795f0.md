# Customer Usage | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/customer_usage
- Final URL: https://docs.litellm.ai/docs/proxy/customer_usage
- Canonical URL: https://docs.litellm.ai/docs/proxy/customer_usage
- Fetched at: 2026-06-23T14:30:01Z
...
Track spend with customer ID in header
...
Configure Claude Code with customer tracking
