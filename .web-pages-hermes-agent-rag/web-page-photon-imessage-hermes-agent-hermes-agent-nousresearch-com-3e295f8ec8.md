# Photon iMessage | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/photon
- Fetched at: 2026-06-23T14:17:05Z
- Content type: text/html; charset=utf-8

## Description

Connect Hermes to iMessage through Photon, a managed
...
The setup, in order:
Device login ( client_id=photon-cli ) — opens
https://app.photon.codes/ for approval and stores the bearer token.
Finds or creates the Hermes Agent project on your account.
Enables Spectrum , reads the project's Spectrum id, and rotates
the project secret.
Registers your phone number as a Spectrum user — skipped if a
user with that number already exists, so re-running is safe.
Prints your assigned iMessage line — the number you text to reach
your agent.
Runs npm install inside the plugin's sidecar directory.
