...
- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/cron-troubleshooting
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/cron-troubleshooting
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/cron-troubleshooting
- Fetched at: 2026-06-23T14:14:59Z
...
Your expression Should evaluate to 0 9 * * * 9:00 AM every day 0 9 * * 1 9:00 AM every Monday every 2h Every 2 hours from now 30m 30 minutes from now 2025-06-01T09:00:00 June 1, 2025 at 9:00 AM UTC
...
~/.hermes/logs/agent.log for scheduler messages (or errors.log for warnings)
The job's last_run metadata via hermes cron list
...
Run the job with hermes cron run <job_id> (fires on next gateway tick) and watch for errors in the chat output
Check ~/.hermes/logs/agent.log for scheduler messages and ~/.hermes/logs/errors.log for warnings
Open an issue at github.com/NousResearch/hermes-agent with:
