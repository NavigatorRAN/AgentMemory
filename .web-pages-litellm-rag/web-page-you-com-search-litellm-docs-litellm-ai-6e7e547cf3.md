# You.com Search | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/search/you_com
- Final URL: https://docs.litellm.ai/docs/search/you_com
- Canonical URL: https://docs.litellm.ai/docs/search/you_com
- Fetched at: 2026-06-23T14:33:11Z
- Content type: text/html; charset=utf-8

## Description

Get API Key (optional, for higher rate limits)//you.com/docs
...
Mode Endpoint Auth Limits Keyless free tier (default) https://api.you.com/v1/agents/search none IP-throttled, ~100 queries/day Keyed tier https://ydc-index.io/v1/search X-API-Key higher rate limits
...
Unified spec parameter Mapped to You.com parameter max_results count search_domain_filter include_domains country country (lowercased) max_tokens_per_page ignored (no equivalent)
