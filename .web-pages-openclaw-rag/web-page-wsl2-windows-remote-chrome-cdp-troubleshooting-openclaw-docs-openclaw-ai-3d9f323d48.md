...
- Requested URL: https://docs.openclaw.ai/tools/browser-wsl2-windows-remote-cdp-troubleshooting
- Final URL: https://docs.openclaw.ai/tools/browser-wsl2-windows-remote-cdp-troubleshooting
- Canonical URL: https://docs.openclaw.ai/tools/browser-wsl2-windows-remote-cdp-troubleshooting
- Fetched at: 2026-06-23T14:57:32Z
...
powershell Copy code chrome.exe --remote-debugging-port = 9222
From Windows, verify Chrome itself first:
powershell Copy code curl http:// 127.0 . 0.1 : 9222 /json/version curl http:// 127.0 . 0.1 : 9222 /json/list
...
bash Copy code curl http://WINDOWS_HOST_OR_IP:9222/json/version curl http://WINDOWS_HOST_OR_IP:9222/json/list
Good result:
...
json5 Copy code { browser : { enabled : true , defaultProfile : "remote" , profiles : { remote : { cdpUrl : "http://WINDOWS_HOST_OR_IP:9222" , attachOnly : true , color : "#00AA00" , }, }, }, }
Notes:
...
From WSL2:
bash Copy code openclaw browser open https://example.com --browser-profile remote openclaw browser tabs --browser-profile remote
...
Are you trying to use existing-session across WSL2 and Windows instead of raw remote CDP?
Practical takeaway
