# Sketch — Throwaway HTML mockups: 2-3 design variants to compare | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-sketch
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-sketch
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-sketch
- Fetched at: 2026-06-23T14:18:01Z
...
Throwaway HTML mockups: 2-3 design variants to compare.
Skill metadata ​
Source Bundled (installed by default) Path skills/creative/sketch Version 1.0.0 Author Hermes Agent (adapted from gsd-build/get-shit-done) License MIT Platforms linux, macos, windows Tags sketch , mockup , design , ui , prototype , html , variants , exploration , wireframe , comparison Related skills spike , claude-design , popular-web-designs , excalidraw
