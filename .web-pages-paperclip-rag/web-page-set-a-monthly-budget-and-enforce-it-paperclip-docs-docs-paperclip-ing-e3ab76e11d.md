# Set a monthly budget and enforce it | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/how-to/set-monthly-budget
- Final URL: https://docs.paperclip.ing/how-to/set-monthly-budget/
- Canonical URL: https://docs.paperclip.ing/how-to/set-monthly-budget
- Fetched at: 2026-06-23T13:38:31Z
- Content type: text/html; charset=utf-8

## Description

Autonomous agents make real API calls. A misconfigured loop, an over-eager prompt, or a pricing change can run a four-figure tab in a weekend if nothing pulls the brake. Paperclip'
...
Field Default metric billed_cents windowKind calendar_month_utc for company/agent, lifetime for project warnPercent 80 hardStopEnabled true notifyEnabled true isActive true
...
Set a tiny cap on the agent — say $0.50 :
...
See also
Costs guide — the full UI walkthrough for the Costs page (Overview, Budgets, Providers, Billers, Finance).
Costs API reference — every endpoint touched here, plus reading routes ( /costs/summary , /costs/by-agent , /costs/window-spend ).
Handle board approvals for hires — the same governance flow but for new agent budgets at hire time.
