...
- Requested URL: https://docs.openclaw.ai/tools/perplexity-search
- Final URL: https://docs.openclaw.ai/tools/perplexity-search
- Canonical URL: https://docs.openclaw.ai/tools/perplexity-search
- Fetched at: 2026-06-23T14:58:09Z
- Content type: text/html; charset=utf-8

## Description

Perplexity Search API and Sonar/OpenRouter compatibility for web_search
...
Store the key in config or set PERPLEXITY_API_KEY in the Gateway environment.
...
json5 Copy code { plugins : { entries : { perplexity : { config : { webSearch : { apiKey : "pplx-..." , }, }, }, }, }, tools : { web : { search : { provider : "perplexity" , }, }, }, }
OpenRouter / Sonar compatibility
json5 Copy code { plugins : { entries : { perplexity : { config : { webSearch : { apiKey : "<openrouter-api-key>" , baseUrl : "https://openrouter.ai/api/v1" , model : "perplexity/sonar-pro" , }, }, }, }, }, tools : { web : { search : { provider : "perplexity" , }, }, }, }
