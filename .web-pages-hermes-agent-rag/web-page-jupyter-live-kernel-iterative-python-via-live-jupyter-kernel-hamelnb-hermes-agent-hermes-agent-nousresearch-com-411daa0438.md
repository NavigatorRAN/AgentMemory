# Jupyter Live Kernel — Iterative Python via live Jupyter kernel (hamelnb) | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel
- Fetched at: 2026-06-23T14:18:05Z
...
Iterative Python via live Jupyter kernel (hamelnb).
Skill metadata ​
Source Bundled (installed by default) Path skills/data-science/jupyter-live-kernel Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags jupyter , notebook , repl , data-science , exploration , iterative
