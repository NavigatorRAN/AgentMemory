# DingTalk | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/dingtalk
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/dingtalk
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/dingtalk
- Fetched at: 2026-06-23T14:16:51Z
- Content type: text/html; charset=utf-8

## Description

Set up Hermes Agent as a DingTalk chatbot
...
How Hermes Behaves ​
Context Behavior DMs (1:1 chat) Hermes responds to every message. No @mention needed. Each DM has its own session. Group chats Hermes responds when you @mention it. Without a mention, Hermes ignores the message. Shared groups with multiple users By default, Hermes isolates session history per user inside the group. Two people talking in the same group do not share one transcript unless you explicitly disable that.
...
Go to the DingTalk Developer Console .
Log in with your DingTalk admin account.
Click Application Development → Custom Apps → Create App via H5 Micro-App (or Robot depending on your console version).
Fill in:
...
In your app's settings page, go to Add Capability → Robot .
Enable the robot capability.
Under Message Reception Mode , select Stream Mode (recommended — no public URL needed).
tip
...
Alternatively, the bot logs the sender_id for each incoming message. Start the gateway, send the bot a message, then check the logs for your ID.
