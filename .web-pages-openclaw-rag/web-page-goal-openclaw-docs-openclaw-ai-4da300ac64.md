...
- Requested URL: https://docs.openclaw.ai/tools/goal
- Final URL: https://docs.openclaw.ai/tools/goal
- Canonical URL: https://docs.openclaw.ai/tools/goal
- Fetched at: 2026-06-23T14:57:50Z
...
Quick start
Set a goal:
text Copy code /goal start get CI green for PR 87469 and push the fix
Check it:
text Copy code /goal
Pause it when work is intentionally waiting:
text Copy code /goal pause waiting for CI
Resume it:
text Copy code /goal resume
Mark it complete:
text Copy code /goal complete pushed and verified
Clear it:
text Copy code /goal clear
What goals are for
...
A goal is not a task queue. Use Task Flow ,
tasks , cron jobs , or
standing orders when work should run detached,
...
text Copy code Goal Status: active Objective: get CI green for PR 87469 and push the fix Tokens used: 12k Token budget: 12k/50k Commands: /goal pause, /goal complete, /goal clear
Commands:
