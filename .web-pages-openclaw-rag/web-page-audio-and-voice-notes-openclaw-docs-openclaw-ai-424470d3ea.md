...
- Requested URL: https://docs.openclaw.ai/nodes/audio
- Final URL: https://docs.openclaw.ai/nodes/audio
- Canonical URL: https://docs.openclaw.ai/nodes/audio
- Fetched at: 2026-06-23T14:49:05Z
...
json5 Copy code { tools : { media : { audio : { enabled : true , maxBytes : 20971520 , models : [ { provider : "openai" , model : "gpt-4o-mini-transcribe" }, { type : "cli" , command : "whisper" , args : [ "--model" , "base" , "{{MediaPath}}" ], timeoutSeconds : 45 , }, ], }, }, }, }
Provider-only with scope gating
json5 Copy code { tools : { media : { audio : { enabled : true , scope : { default : "allow" , rules : [{ action : "deny" , match : { chatType : "group" } }], }, models : [{ provider : "openai" , model : "gpt-4o-mini-transcribe" }], }, }, }, }
Provider-only (Deepgram)
json5 Copy code { tools : { media : { audio : { enabled : true , models : [{ provider : "deepgram" , model : "nova-3" }], }, }, }, }
Provider-only (Mistral Voxtral)
json5 Copy code { tools : { media : { audio : { enabled : true , models : [{ provider : "mistral" , model : "voxtral-mini-latest" }], }, }, }, }
...
json5 Copy code { tools : { media : { audio : { enabled : true , echoTranscript : true , // default is false echoFormat : '📝 "{transcript}"' , // optional, supports {transcript} models : [{ provider : "openai" , model : "gpt-4o-mini-transcribe" }], }, }, }, }
Notes and limits
