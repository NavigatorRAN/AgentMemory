...
- Requested URL: https://docs.openclaw.ai/concepts/messages
- Final URL: https://docs.openclaw.ai/concepts/messages
- Canonical URL: https://docs.openclaw.ai/concepts/messages
- Fetched at: 2026-06-23T14:38:53Z
...
Code Copy code Inbound message -> routing/bindings -> session key -> queue (if a run is active) -> agent run (streaming + tools) -> outbound replies (channel limits + chunking)
...
json5 Copy code { messages : { inbound : { debounceMs : 2000 , byChannel : { whatsapp : 5000 , slack : 1500 , discord : 1500 , }, }, }, }
Notes:
