...
- Requested URL: https://docs.openclaw.ai/reference/test
- Final URL: https://docs.openclaw.ai/reference/test
- Canonical URL: https://docs.openclaw.ai/reference/test
- Fetched at: 2026-06-23T14:56:57Z
...
pnpm test:changed for changed-scope Vitest proof.
pnpm test <path-or-filter> for one file, directory, or explicit target.
pnpm test only when you intentionally need the full local Vitest suite.
...
bash Copy code scripts/e2e/onboard-docker.sh
...
bash Copy code pnpm test :docker:qr
Related
Testing
Testing live
