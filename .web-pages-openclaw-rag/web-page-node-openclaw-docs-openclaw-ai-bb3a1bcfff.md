...
- Requested URL: https://docs.openclaw.ai/cli/node
- Final URL: https://docs.openclaw.ai/cli/node
- Canonical URL: https://docs.openclaw.ai/cli/node
- Fetched at: 2026-06-23T14:37:53Z
...
json5 Copy code { nodeHost : { browserProxy : { enabled : false , }, }, }
Run (foreground)
...
bash Copy code openclaw node install --host <gateway-host> --port 18789
--runtime <runtime> : Service runtime ( node or bun )
--force : Reinstall/overwrite if already installed
Manage the service:
bash Copy code openclaw node status openclaw node start openclaw node stop openclaw node restart openclaw node uninstall
