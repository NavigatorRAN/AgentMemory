# Codex — Delegate coding to OpenAI Codex CLI (features, PRs) | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex
- Fetched at: 2026-06-23T14:17:39Z
...
Delegate coding to OpenAI Codex CLI (features, PRs).
Skill metadata ​
Source Bundled (installed by default) Path skills/autonomous-ai-agents/codex Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags Coding-Agent , Codex , OpenAI , Code-Review , Refactoring Related skills claude-code , hermes-agent
...
Key Flags ​
Flag Effect exec "prompt" One-shot execution, exits when done --full-auto Sandboxed but auto-approves file changes in workspace --yolo No sandbox, no approvals (fastest, most dangerous) --sandbox danger-full-access No Codex sandbox; useful when the host service context breaks bubblewrap
