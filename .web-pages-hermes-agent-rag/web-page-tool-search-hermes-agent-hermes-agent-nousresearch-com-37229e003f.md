# Tool Search | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-search
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-search
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-search
- Fetched at: 2026-06-23T14:16:37Z
...
max_search_limit : 20
Key Default Meaning enabled auto auto activates above threshold; on always activates if there's at least one deferrable tool; off disables entirely. threshold_pct 10 Percentage of context length at which auto mode kicks in. Range 0–100. search_default_limit 5 Hits returned when the model calls tool_search without a limit . max_search_limit 20 Hard upper bound the model can request via limit . Range 1–50.
