# /skills - Anthropic Skills API | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/skills
- Final URL: https://docs.litellm.ai/docs/skills
- Canonical URL: https://docs.litellm.ai/docs/skills
- Fetched at: 2026-06-23T14:33:24Z
...
On this page
Copy as Markdown
Feature Supported Cost Tracking ✅ Logging ✅ Load Balancing ✅ Supported Providers anthropic
tip
LiteLLM follows the Anthropic Skills API for creating, managing, and using reusable AI capabilities.
...
Field Required Description name Yes Skill identifier (lowercase, numbers, hyphens only). Must match the directory name. description Yes Brief description of the skill license No License type (e.g., MIT, Apache-2.0) allowed-tools No List of Claude tools this skill can use metadata No Additional custom metadata
...
"last_id" : "skill_02def"
Supported Providers ​
Provider Link to Usage Anthropic Usage
LiteLLM Python SDK Usage
Quick Start - Create a Skill
List Skills
Get Skill Details
