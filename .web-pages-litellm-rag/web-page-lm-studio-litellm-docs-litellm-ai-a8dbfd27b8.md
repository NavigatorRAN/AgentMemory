...
- Requested URL: https://docs.litellm.ai/docs/providers/lm_studio
- Final URL: https://docs.litellm.ai/docs/providers/lm_studio
- Canonical URL: https://docs.litellm.ai/docs/providers/lm_studio
- Fetched at: 2026-06-23T14:28:15Z
...
Property Details Description Discover, download, and run local LLMs. Provider Route on LiteLLM lm_studio/ Provider Doc LM Studio ↗ Supported OpenAI Endpoints /chat/completions , /embeddings , /completions
API Key ​
# env variable
