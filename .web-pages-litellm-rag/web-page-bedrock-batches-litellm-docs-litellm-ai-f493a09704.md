# Bedrock Batches | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/providers/bedrock_batches
- Final URL: https://docs.litellm.ai/docs/providers/bedrock_batches
- Canonical URL: https://docs.litellm.ai/docs/providers/bedrock_batches
...
Copy as Markdown
Use Amazon Bedrock Batch Inference API through LiteLLM.
Property Details Description Amazon Bedrock Batch Inference allows you to run inference on large datasets asynchronously Provider Doc AWS Bedrock Batch Inference ↗ Cost Tracking ✅ Supported
Overview ​
Use this to:
...
Optional Parameters:
Parameter Description s3_encryption_key_id Custom KMS encryption key ID for S3 output data. If not specified, Bedrock uses AWS managed encryption keys.
