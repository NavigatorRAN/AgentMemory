# MCP Cost Tracking | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/mcp_cost
- Final URL: https://docs.litellm.ai/docs/mcp_cost
- Canonical URL: https://docs.litellm.ai/docs/mcp_cost
- Fetched at: 2026-06-23T14:24:34Z
...
Copy as Markdown
LiteLLM provides two ways to track costs for MCP tool calls:
Method When to Use What It Does Config-based Cost Tracking Simple cost tracking with fixed costs per tool/server Automatically tracks costs based on configuration Custom Post-MCP Hook Dynamic cost tracking with custom logic Allows custom cost calculations and response modifications
