# Debug a stuck heartbeat | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/how-to/debug-stuck-heartbeat
- Final URL: https://docs.paperclip.ing/how-to/debug-stuck-heartbeat/
- Canonical URL: https://docs.paperclip.ing/how-to/debug-stuck-heartbeat
- Fetched at: 2026-06-23T13:38:23Z
- Content type: text/html; charset=utf-8

## Description

Five symptoms that cover almost every "this agent isn't working right" report. Open the agent's detail page and scroll to Run history before you start — every diagnosis below begin
...
Break the work into child issues ( POST /api/companies/{companyId}/issues with parentId ).
Tighten context — prefer GET /api/issues/{issueId}/heartbeat-context over full-repo reads.
Move long single-shot work to a routine off the heartbeat path.
