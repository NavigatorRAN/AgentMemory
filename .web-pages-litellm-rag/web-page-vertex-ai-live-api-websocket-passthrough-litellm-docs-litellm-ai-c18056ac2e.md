# Vertex AI Live API WebSocket Passthrough | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/pass_through/vertex_ai_live_websocket
- Final URL: https://docs.litellm.ai/docs/pass_through/vertex_ai_live_websocket
- Canonical URL: https://docs.litellm.ai/docs/pass_through/vertex_ai_live_websocket
- Fetched at: 2026-06-23T14:25:58Z
...
API Key : Pass Authorization: Bearer your-api-key header
...
Vertex AI Live API Reference
LiteLLM Proxy Configuration
Vertex AI Passthrough Endpoints
Overview
Configuration
Environment Variables
Configuration File
