# WhatsApp group messages - OpenClaw

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.openclaw.ai/channels/group-messages
- Final URL: https://docs.openclaw.ai/channels/group-messages
- Canonical URL: https://docs.openclaw.ai/channels/group-messages
- Fetched at: 2026-06-23T14:36:06Z
...
json5 Copy code { channels : { whatsapp : { groups : { "*" : { requireMention : true }, }, }, }, agents : { list : [ { id : "main" , groupChat : { historyLimit : 50 , mentionPatterns : [ "@?openclaw" , "\\+?15555550123" ], }, }, ], }, }
Notes:
...
Session-level directives ( /verbose on , /trace on , /think high , /new or /reset , /compact ) apply only to that group's session; send them as standalone messages so they register. Your personal DM session remains independent.
