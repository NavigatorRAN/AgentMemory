# Managed Scope | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/managed-scope
- Fetched at: 2026-06-23T14:16:48Z
...
Tier config.yaml .env 1 /etc/hermes/config.yaml (managed) /etc/hermes/.env (managed) 2 ~/.hermes/config.yaml (user) ~/.hermes/.env (user) 3 built-in defaults pre-existing shell environment
