...
- Requested URL: https://docs.openclaw.ai/cli/secrets
- Final URL: https://docs.openclaw.ai/cli/secrets
- Canonical URL: https://docs.openclaw.ai/cli/secrets
- Fetched at: 2026-06-23T14:38:06Z
...
bash Copy code openclaw secrets audit --check openclaw secrets configure openclaw secrets apply --from /tmp/openclaw-secrets-plan.json --dry-run openclaw secrets apply --from /tmp/openclaw-secrets-plan.json openclaw secrets audit --check openclaw secrets reload
...
bash Copy code openclaw secrets reload openclaw secrets reload --json openclaw secrets reload --url ws://127.0.0.1:18789 --token <token>
Notes:
...
bash Copy code openclaw secrets audit openclaw secrets audit --check openclaw secrets audit --json openclaw secrets audit --allow-exec
Exit behavior:
...
bash Copy code openclaw secrets configure openclaw secrets configure --plan-out /tmp/openclaw-secrets-plan.json openclaw secrets configure --apply -- yes openclaw secrets configure --providers-only openclaw secrets configure --skip-provider-setup openclaw secrets configure --agent ops openclaw secrets configure --json
Flow:
...
Example
bash Copy code openclaw secrets audit --check openclaw secrets configure openclaw secrets audit --check
