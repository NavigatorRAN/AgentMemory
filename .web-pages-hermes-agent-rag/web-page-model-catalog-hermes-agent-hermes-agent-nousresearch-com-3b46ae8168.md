# Model Catalog | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/reference/model-catalog
- Final URL: https://hermes-agent.nousresearch.com/docs/reference/model-catalog
- Canonical URL: https://hermes-agent.nousresearch.com/docs/reference/model-catalog
- Fetched at: 2026-06-23T14:15:36Z
...
Fetch behavior ​
When What happens /model or hermes model Fetches if disk cache is stale, else uses cache Disk cache fresh (< TTL) No network hit Network failure with cache Silent fallback to cache, one log line Network failure, no cache Silent fallback to in-repo snapshot Manifest fails schema validation Treated as unreachable
