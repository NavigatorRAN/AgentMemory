...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-pptx-author
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-pptx-author
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-pptx-author
- Fetched at: 2026-06-23T14:19:38Z
...
Skill metadata ​
Source Optional — install with hermes skills install official/finance/pptx-author Path optional-skills/finance/pptx-author Version 1.0.0 Author Anthropic (adapted by Nous Research) License Apache-2.0 Platforms linux, macos, windows Tags powerpoint , pptx , python-pptx , presentation , finance Related skills excel-author , powerpoint
