...
- Requested URL: https://docs.pi-hole.net/guides/dns/cloudflared
- Final URL: https://docs.pi-hole.net/guides/dns/cloudflared/
- Canonical URL: https://docs.pi-hole.net/guides/dns/cloudflared/
- Fetched at: 2026-06-23T13:42:17Z
...
# Commandline args for cloudflared, using Cloudflare DNS CLOUDFLARED_OPTS = --port 5053 --upstream https://cloudflare-dns.com/dns-query
...
# Commandline args for cloudflared, using Cloudflare DNS CLOUDFLARED_OPTS = --port 5053 --upstream https://1.1.1.1/dns-query --upstream https://1.0.0.1/dns-query --address 0 .0.0.0
...
Guide based on this guide by Ben Dews | bendews.com ↩
February 12, 2026
Back to top
