...
- Requested URL: https://docs.litellm.ai/docs/providers/voyage
- Final URL: https://docs.litellm.ai/docs/providers/voyage
- Canonical URL: https://docs.litellm.ai/docs/providers/voyage
- Fetched at: 2026-06-23T14:29:23Z
...
Model Best For Context Length Price/M Tokens voyage-3.5 General-purpose, multilingual 32K $0.06 voyage-3.5-lite Latency-sensitive applications 32K $0.02 voyage-3-large Best overall quality 32K $0.18 voyage-code-3 Code retrieval and search 32K $0.18 voyage-finance-2 Financial documents 32K $0.12 voyage-law-2 Legal documents 16K $0.12 voyage-context-3 Contextual document embeddings 32K $0.18
Rerank ​
...
Model Context Length Description Price/M Tokens rerank-2.5 32K Best quality, multilingual, instruction-following $0.05 rerank-2.5-lite 32K Optimized for latency and cost $0.02 rerank-2 16K Legacy model $0.05 rerank-2-lite 8K Legacy model, faster $0.02
Parameter Type Description model string Model name (e.g., voyage/rerank-2.5 ) query string The search query documents list List of documents to rerank top_n int Number of top results to return return_documents bool Whether to include document text in response
API Key
Sample Usage - Embedding
Supported Parameters
Example with Parameters
