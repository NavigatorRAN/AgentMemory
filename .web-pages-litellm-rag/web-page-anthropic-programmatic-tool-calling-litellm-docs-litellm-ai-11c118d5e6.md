# Anthropic Programmatic Tool Calling | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/providers/anthropic_programmatic_tool_calling
- Final URL: https://docs.litellm.ai/docs/providers/anthropic_programmatic_tool_calling
- Canonical URL: https://docs.litellm.ai/docs/providers/anthropic_programmatic_tool_calling
- Fetched at: 2026-06-23T14:26:45Z
...
Model Tool Version Claude Opus 4.5 ( claude-opus-4-5-20251101 ) code_execution_20250825 Claude Sonnet 4.5 ( claude-sonnet-4-5-20250929 ) code_execution_20250825
Quick Start ​
...
When a tool function is called, code execution pauses and the API returns a tool_use block with a caller field
