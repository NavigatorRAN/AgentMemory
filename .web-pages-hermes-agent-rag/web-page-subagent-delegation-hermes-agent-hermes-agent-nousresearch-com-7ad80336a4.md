...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/delegation
- Fetched at: 2026-06-23T14:16:10Z
...
Toolset Pattern Use Case ["terminal", "file"] Code work, debugging, file editing, builds ["web"] Research, fact-checking, documentation lookup ["terminal", "file", "web"] Full-stack tasks (default) ["file"] Read-only analysis, code review without execution ["terminal"] System administration, process management
