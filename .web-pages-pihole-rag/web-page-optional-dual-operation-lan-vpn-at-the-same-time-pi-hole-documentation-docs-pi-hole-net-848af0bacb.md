# Optional: Dual operation: LAN & VPN at the same time - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/guides/vpn/openvpn/dual-operation
- Final URL: https://docs.pi-hole.net/guides/vpn/openvpn/dual-operation/
- Canonical URL: https://docs.pi-hole.net/guides/vpn/openvpn/dual-operation/
- Fetched at: 2026-06-23T13:42:56Z
...
So if blocking works using eth0 but stops working for tun0 , as described here , you may want to run this command pihole -a -i all , which should get the behavior you want by opening pihole- FTL up to listen on all ports. This is not recommended for cloud servers as they should not be listening on eth0 .
