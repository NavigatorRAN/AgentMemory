# Kanban Codex Lane | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-kanban-codex-lane
- Fetched at: 2026-06-23T14:17:42Z
- Content type: text/html; charset=utf-8

## Description

Use when a Hermes Kanban worker wants to run Codex CLI as an isolated implementation lane while Hermes keeps ownership of task lifecycle, reconciliation, tes...
...
Skill metadata ​
Source Bundled (installed by default) Path skills/autonomous-ai-agents/kanban-codex-lane Version 1.0.0 Author Hermes Agent License MIT Tags kanban , codex , worktrees , autonomous-agents , prediction-market-bot Related skills codex , hermes-agent
...
Ownership Rules ​
Hermes owns the Kanban lifecycle. Codex must never call kanban_complete , kanban_block , kanban_create , gateway messaging, or any Hermes board CLI as a substitute for the worker.
...
Using /goal for quick edits. Prefer codex exec unless durable multi-step continuation is needed.
Killing a stuck lane without recording why. rejected_reason must explain the decision.
Accepting broad unrelated cleanup because tests pass. Reject or cherry-pick only the scoped changes.
