...
- Requested URL: https://www.home-assistant.io/integrations/tplink
- Final URL: https://www.home-assistant.io/integrations/tplink
- Canonical URL: https://www.home-assistant.io/integrations/tplink/
- Fetched at: 2026-06-28T03:23:19Z
- Content type: text/html; charset=UTF-8

## Description

Instructions on integrating TP-Link Smart Home Devices to Home Assistant.
...
The TP-Link Smart Home integration Integrations connect and integrate Home Assistant with your devices, services, and more. [Learn more] allows you to control your TP-Link Kasa Smart Home Devices and TP-Link Tapo Devices such as cameras, doorbells, chimes, lights, plugs, wall switches, robot vacuums, hubs, and hub-attached devices.
...
To add the TP-Link Smart Home device to your Home Assistant instance, use this My button:
TP-Link Smart Home can be auto-discovered by Home Assistant. If an instance was found,
...
Check the reported connection solutions section below.
...
Raise a support issue. See the section below for guidelines.
...
Raise an issue with Home Assistant Core .
Fill in as many of the fields in the issue template as you can.
If applicable, list all steps taken from the Troubleshooting device connections section above.
Upload debug logs that run from Home Assistant first starting up, until the error is encountered.
To capture debug logs from Home Assistant first starting up, update configuration.yaml to look like this:
logger : default : warning # This will already be present. Add the lines below. logs : homeassistant.components.tplink : debug kasa : debug
...
The TP-Link Smart Home integration Integrations connect and integrate Home Assistant with your devices, services, and more. [Learn more] provides the following actions. Each link below opens a dedicated page with examples, parameters, and a step-by-step UI walkthrough.
Random effect ( tplink.random_effect )
Sets a random light effect on a TP-Link light strip.
Sequence effect ( tplink.sequence_effect )
Sets a sequence light effect on a TP-Link light strip.
...
The TP-Link Smart Home device was introduced in Home Assistant 0.89, and it's used by
13.9% of the active installations.
