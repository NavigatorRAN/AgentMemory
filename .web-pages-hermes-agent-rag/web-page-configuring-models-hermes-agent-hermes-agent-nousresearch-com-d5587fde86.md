# Configuring Models | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/configuring-models
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/configuring-models
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/configuring-models
- Fetched at: 2026-06-23T14:15:49Z
...
Is provider set to something other than auto ? If the field shows auto , the task is still using your main model. Click Change and pick a real provider.
Is the provider authenticated? If you assigned minimax to a task but don't have a MiniMax API key, that task falls back to the openrouter default and logs a warning in agent.log .
