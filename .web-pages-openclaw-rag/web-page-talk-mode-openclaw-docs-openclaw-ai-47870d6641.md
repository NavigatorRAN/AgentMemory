...
- Requested URL: https://docs.openclaw.ai/nodes/talk
- Final URL: https://docs.openclaw.ai/nodes/talk
- Canonical URL: https://docs.openclaw.ai/nodes/talk
- Fetched at: 2026-06-23T14:49:11Z
...
Speak it via the configured Talk provider ( talk.speak )
...
json Copy code { "voice" : "<voice-id>" , "once" : true }
Rules:
