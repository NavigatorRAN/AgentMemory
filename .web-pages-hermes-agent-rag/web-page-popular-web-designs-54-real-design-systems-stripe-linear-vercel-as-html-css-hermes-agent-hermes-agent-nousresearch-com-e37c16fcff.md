# Popular Web Designs — 54 real design systems (Stripe, Linear, Vercel) as HTML/CSS | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-popular-web-designs
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-popular-web-designs
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-popular-web-designs
- Fetched at: 2026-06-23T14:17:59Z
...
54 real design systems (Stripe, Linear, Vercel) as HTML/CSS.
Skill metadata ​
Source Bundled (installed by default) Path skills/creative/popular-web-designs Version 1.0.0 Author Hermes Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md) License MIT Platforms linux, macos, windows
