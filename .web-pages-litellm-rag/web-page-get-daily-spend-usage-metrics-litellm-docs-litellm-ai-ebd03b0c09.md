# 💸 GET Daily Spend, Usage Metrics | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/metrics
- Final URL: https://docs.litellm.ai/docs/proxy/metrics
- Canonical URL: https://docs.litellm.ai/docs/proxy/metrics
- Fetched at: 2026-06-23T14:31:25Z
