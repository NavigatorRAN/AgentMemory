# Group Management - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/database/domain-database/groups
- Final URL: https://docs.pi-hole.net/database/domain-database/groups/
- Canonical URL: https://docs.pi-hole.net/database/domain-database/groups/
- Fetched at: 2026-06-23T13:41:27Z
...
Label Type Uniqueness enforced Content id integer Yes Unique ID for database operations enabled boolean No Flag whether domains in this group should be used
( 0 = disabled, 1 = enabled) name text Yes Mandatory group name description text No Optional field for arbitrary user comments
...
Label Type Content domainlist_id integer id of domain in the domainlist table group_id integer id of associated group in the group table
