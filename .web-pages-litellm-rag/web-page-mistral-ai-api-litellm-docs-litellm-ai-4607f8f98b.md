...
- Requested URL: https://docs.litellm.ai/docs/providers/mistral
- Final URL: https://docs.litellm.ai/docs/providers/mistral
- Canonical URL: https://docs.litellm.ai/docs/providers/mistral
- Fetched at: 2026-06-23T14:28:20Z
...
Model Name Function Call Magistral Small completion(model="mistral/magistral-small-2506", messages) Magistral Medium completion(model="mistral/magistral-medium-2506", messages)
...
Parameter Type Description diarize bool Enable speaker diarization
diarize = True ,
- model_name : voxtral
model : mistral/voxtral - mini - latest
...
Model Name Function Call Mistral Embeddings embedding(model="mistral/mistral-embed", input)
API Key
Sample Usage
Sample Usage - Streaming
Usage with LiteLLM Proxy
