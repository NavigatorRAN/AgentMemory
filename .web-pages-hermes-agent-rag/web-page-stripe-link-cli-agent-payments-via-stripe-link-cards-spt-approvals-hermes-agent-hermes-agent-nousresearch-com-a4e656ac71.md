# Stripe Link Cli — Agent payments via Stripe Link — cards, SPT, approvals | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/payments/payments-stripe-link-cli
- Fetched at: 2026-06-23T14:20:26Z
...
Agent payments via Stripe Link — cards, SPT, approvals.
Skill metadata ​
Source Optional — install with hermes skills install official/payments/stripe-link-cli Path optional-skills/payments/stripe-link-cli Version 0.1.0 Author Teknium (teknium1), Hermes Agent License MIT Platforms linux, macos Tags Payments , Stripe , Link , Checkout , MPP Related skills mpp-agent , stripe-projects
...
Merchant surface --credential-type Standard web checkout form / Stripe Elements card (default) Returns HTTP 402 with method="stripe" in www-authenticate shared_payment_token Returns HTTP 402 without method="stripe" unsupported — stop
