# MAX_CALLBACKS Limit | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/troubleshoot/max_callbacks
- Final URL: https://docs.litellm.ai/docs/troubleshoot/max_callbacks
- Canonical URL: https://docs.litellm.ai/docs/troubleshoot/max_callbacks
...
Recommendations ​
Start conservative - Only increase as much as you need. If you have 60 teams with guardrails, try LITELLM_MAX_CALLBACKS=75 to leave headroom.
Monitor performance - More callbacks means more processing per request. Watch your CPU usage and response latency after increasing the limit.
Consolidate where possible - If multiple teams use identical guardrails, consider using shared callback configurations rather than per-team duplicates.
