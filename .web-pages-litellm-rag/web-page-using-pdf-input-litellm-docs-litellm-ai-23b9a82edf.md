...
- Requested URL: https://docs.litellm.ai/docs/completion/document_understanding
- Final URL: https://docs.litellm.ai/docs/completion/document_understanding
- Canonical URL: https://docs.litellm.ai/docs/completion/document_understanding
- Fetched at: 2026-06-23T14:23:07Z
...
Call /model_group/info to check if a model supports pdf input
curl -X 'GET' \
