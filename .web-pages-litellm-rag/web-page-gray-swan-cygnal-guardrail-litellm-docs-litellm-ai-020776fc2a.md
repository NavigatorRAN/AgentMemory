# Gray Swan Cygnal Guardrail | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/grayswan
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/grayswan
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/grayswan
- Fetched at: 2026-06-23T14:30:28Z
...
Log in to our Gray Swan platform and generate a Cygnal API key.
For existing customers, you should already have access to our platform .
For new users, please register at this page and we are more than happy to give you an onboarding!
Configure environment variables for the LiteLLM proxy host:
...
Mode When it Runs Protects Typical Use Case pre_call Before LLM call User input only Block prompt injection before it reaches the model during_call Parallel to call User input only Low-latency monitoring without blocking post_call After response Model Outputs Scan output for policy violations, leaked secrets, or IPI
