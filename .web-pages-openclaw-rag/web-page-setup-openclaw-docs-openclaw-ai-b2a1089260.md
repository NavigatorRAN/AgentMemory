...
- Requested URL: https://docs.openclaw.ai/start/setup
- Final URL: https://docs.openclaw.ai/start/setup
- Canonical URL: https://docs.openclaw.ai/start/setup
- Fetched at: 2026-06-23T14:57:14Z
...
For onboarding details, see Onboarding (CLI) .
TL;DR
...
bash Copy code node openclaw.mjs gateway --port 18789 --verbose
...
bash Copy code ./scripts/restart-mac.sh
1) Start the dev Gateway
bash Copy code pnpm install # First run only (or after resetting local OpenClaw config/workspace) pnpm openclaw setup pnpm gateway:watch
...
user service (no lingering needed). See Gateway runbook for the systemd notes.
Related docs
