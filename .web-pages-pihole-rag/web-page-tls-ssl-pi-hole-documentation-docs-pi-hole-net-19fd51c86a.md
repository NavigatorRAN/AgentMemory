# TLS/SSL - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/api/tls
- Final URL: https://docs.pi-hole.net/api/tls/
- Canonical URL: https://docs.pi-hole.net/api/tls/
- Fetched at: 2026-06-23T13:41:22Z
...
Before After
Open the settings page of Firefox at about:preferences#privacy
Search for "Certificates"
Click on "View Certificates"
Select the "Authorities" tab
Click on "Import" and select the CA certificate file (e.g., /etc/pihole/tls_ca.crt )
Check "Trust this CA to identify websites"
Click on "OK"
Verify that the certificate has been imported correctly
Verify that the Pi-hole web interface is now trusted (no warning, secure lock icon)
...
Open the settings page of Chrome at chrome://settings/privacy
Navigate to "Manage certificates" in the "Security" submenu of "Privacy and security" or use the search bar
...
Navigate to "System Security" or "Security & location" (depending on your device)
Navigate to "Credential storage" or similar (depending on your device)
Choose "Install certificates from storage" or similar (depending on your device)
Select "User certificates" or similar (depending on your device)
Select the CA certificate file (e.g., /etc/pihole/tls_ca.crt ) - you need to have the certificate file on your device (e.g., by copying it to your device via Bluetooth or other secure means)
Confirm that you want to install the certificate despite the possible security implications mentioned above
Give the certificate a meaningful name (e.g., "Pi-hole")
Verify that the certificate has been imported correctly by checking for a small success popup in the lower area of the screen
