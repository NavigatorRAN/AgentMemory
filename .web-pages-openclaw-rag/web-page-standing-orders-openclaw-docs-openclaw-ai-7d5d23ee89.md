...
- Requested URL: https://docs.openclaw.ai/automation/standing-orders
- Final URL: https://docs.openclaw.ai/automation/standing-orders
- Canonical URL: https://docs.openclaw.ai/automation/standing-orders
- Fetched at: 2026-06-23T14:35:46Z
...
Triggers - when to execute (schedule, event, or condition)
Approval gates - what requires human sign-off before acting
...
markdown Copy code ## Program 1: [Domain A] (Weekly) ... ## Program 2: [Domain B] (Monthly + On-Demand) ... ## Program 3: [Domain C] (As-Needed) ... ## Escalation Rules (All Programs) - [Common escalation criteria] - [Approval gates that apply across programs]
