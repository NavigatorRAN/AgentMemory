...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/blockchain/blockchain-solana
- Fetched at: 2026-06-23T14:19:10Z
...
Skill metadata ​
Source Optional — install with hermes skills install official/blockchain/solana Path optional-skills/blockchain/solana Version 0.2.0 Author Deniz Alagoz (gizdusum), enhanced by Hermes Agent License MIT Platforms linux, macos, windows Tags Solana , Blockchain , Crypto , Web3 , RPC , DeFi , NFT
