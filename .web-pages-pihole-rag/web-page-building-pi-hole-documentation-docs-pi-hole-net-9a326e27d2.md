# Building - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/docker/build-image
- Final URL: https://docs.pi-hole.net/docker/build-image/
- Canonical URL: https://docs.pi-hole.net/docker/build-image/
- Fetched at: 2026-06-23T13:41:35Z
...
services : pihole : container_name : pihole image : pihole:local ...
