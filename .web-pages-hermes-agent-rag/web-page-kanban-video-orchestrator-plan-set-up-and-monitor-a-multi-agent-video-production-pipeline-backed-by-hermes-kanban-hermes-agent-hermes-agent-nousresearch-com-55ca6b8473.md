# Kanban Video Orchestrator — Plan, set up, and monitor a multi-agent video production pipeline backed by Hermes Kanban | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator
- Fetched at: 2026-06-23T14:19:19Z
...
Skill metadata ​
Source Optional — install with hermes skills install official/creative/kanban-video-orchestrator Path optional-skills/creative/kanban-video-orchestrator Version 1.0.0 Author ['SHL0MS', 'alt-glitch'] License MIT Platforms linux, macos, windows Tags video , kanban , multi-agent , orchestration , production-pipeline Related skills ascii-video , manim-video , p5js , comfyui , touchdesigner-mcp , blender-mcp , pixel-art , ascii-art , songwriting-and-ai-music , heartmula , songsee , spotify , youtube-content , claude-design , excalidraw , architecture-diagram , concept-diagrams , baoyu-comic , baoyu-infographic , humanizer , gif-search , meme-generation
...
Creates the project workspace ( ~/projects/video-pipeline/<slug>/ )
Copies any provided assets into taste/ , audio/ , assets/
Creates each Hermes profile via hermes profile create --clone
Writes per-profile SOUL.md (personality + role definition)
Configures profile YAML (toolsets, always_load skills, cwd)
Writes brief.md , TEAM.md , and taste/ content
Fires the initial hermes kanban create task assigned to the director
...
Comment on the worker's task with specific feedback ( kanban_comment )
Create a re-run task with the original as parent
...
playbook, see references/monitoring.md .
...
task graphs. See references/examples.md .
Critical rules ​
