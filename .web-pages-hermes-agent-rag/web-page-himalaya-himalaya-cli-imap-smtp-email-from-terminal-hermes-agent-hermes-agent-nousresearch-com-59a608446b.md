# Himalaya — Himalaya CLI: IMAP/SMTP email from terminal | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/email/email-himalaya
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/email/email-himalaya
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/email/email-himalaya
- Fetched at: 2026-06-23T14:18:07Z
...
Himalaya CLI: IMAP/SMTP email from terminal.
Skill metadata ​
Source Bundled (installed by default) Path skills/email/himalaya Version 1.1.0 Author community License MIT Platforms linux, macos, windows Tags Email , IMAP , SMTP , CLI , Communication
