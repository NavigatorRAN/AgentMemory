...
- Requested URL: https://docs.openclaw.ai/start/openclaw
- Final URL: https://docs.openclaw.ai/start/openclaw
- Canonical URL: https://docs.openclaw.ai/start/openclaw
- Fetched at: 2026-06-23T14:57:11Z
...
json5 Copy code { gateway : { mode : "local" }, channels : { whatsapp : { allowFrom : [ "+15555550123" ] } }, }
...
json5 Copy code { agents : { defaults : { heartbeat : { every : "30m" }, }, }, }
Media in and out
...
json Copy code { "message" : "Here's the screenshot." , "mediaUrl" : "https://example.com/screenshot.png" }
