...
- Requested URL: https://docs.openclaw.ai/start/wizard-cli-reference
- Final URL: https://docs.openclaw.ai/start/wizard-cli-reference
- Canonical URL: https://docs.openclaw.ai/start/wizard-cli-reference
- Fetched at: 2026-06-23T14:57:18Z
- Content type: text/html; charset=utf-8

## Description

Complete reference for CLI setup flow, auth/model setup, outputs, and internals
