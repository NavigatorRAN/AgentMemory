...
- Requested URL: https://docs.litellm.ai/docs/completion/input
- Final URL: https://docs.litellm.ai/docs/completion/input
- Canonical URL: https://docs.litellm.ai/docs/completion/input
- Fetched at: 2026-06-23T14:23:12Z
...
Type Description Docs text Text content Type Definition image_url Images Vision input_audio Audio input Audio video_url Video input Type Definition file Files Document Understanding document Documents/PDFs Document Understanding
Examples:
# Text
