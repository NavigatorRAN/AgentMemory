...
- Requested URL: https://docs.paperclip.ing/guides/day-to-day/approvals
- Final URL: https://docs.paperclip.ing/guides/day-to-day/approvals/
- Canonical URL: https://docs.paperclip.ing/guides/day-to-day/approvals
- Fetched at: 2026-06-23T13:37:40Z
- Content type: text/html; charset=utf-8

## Description

Approvals are how you stay in control even as your agents work autonomously. Without them, agents could hire new team members, commit to strategies, and make significant decisions
...
A header card with the approval type icon, the proposed agent's name and role, the current status badge, and the approval id (useful when referencing it in a comment or a support channel).
The proposal payload — the structured summary of what the requesting agent is asking for. For hires, this includes:
...
A "See full request" expander that reveals the raw JSON payload for the rare case you need to inspect a specific field the summary view does not highlight.
...
Click on a pending hire approval
...
Click on the strategy approval
...
Read the strategy with your company goal in mind
