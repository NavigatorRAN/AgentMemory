# Session Storage | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage
- Final URL: https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage
- Canonical URL: https://hermes-agent.nousresearch.com/docs/developer-guide/session-storage
- Fetched at: 2026-06-23T14:14:39Z
...
FTS5 Query Syntax ​
Syntax Example Meaning Keywords docker deployment Both terms (implicit AND) Quoted phrase "exact phrase" Exact phrase match Boolean OR docker OR kubernetes Either term Boolean NOT python NOT java Exclude term Prefix deploy* Prefix match
Filtered Search ​
