...
- Requested URL: https://docs.openclaw.ai/tools
- Final URL: https://docs.openclaw.ai/tools
- Canonical URL: https://docs.openclaw.ai/tools
- Fetched at: 2026-06-23T14:57:20Z
...
If you need to... Use this first Then read Let an agent act with existing capabilities Built-in tools Tool categories Control what an agent can call Tool policy Tools and custom providers Teach an agent a workflow Skills Skills , Creating skills , and Skill Workshop Add a new integration or runtime surface Plugins Plugins and Build plugins Run work later or in the background Automation Automation overview Coordinate multiple agents or harnesses Sub-agents ACP agents and Agent send Search a large OpenClaw tool catalog Tool Search Tool Search
...
Skills | Skill Workshop | Creating skills | Skills config
...
Tokenjuice for compacting noisy exec and bash tool
output
Tool Search for discovering and calling large tool
...
current turn:
Check the active profile, tools.allow , and tools.deny in
Check provider-specific restrictions in
Tools and custom providers and confirm the selected
model provider supports the tool shape.
Check channel permissions, sandbox state, and elevated access with
Sandbox vs tool policy vs elevated and Elevated exec .
Check whether the owning plugin is installed and enabled in
Plugins .
For delegated runs, check per-agent restrictions in
Per-agent sandbox and tool restrictions .
For large OpenClaw catalogs, confirm whether the run uses direct tool exposure or
Tool Search .
Related
