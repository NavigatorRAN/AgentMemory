...
- Requested URL: https://docs.openclaw.ai/gateway/logging
- Final URL: https://docs.openclaw.ai/gateway/logging
- Canonical URL: https://docs.openclaw.ai/gateway/logging
- Fetched at: 2026-06-23T14:43:51Z
...
text Copy code agent model: openai/gpt-5.5 (thinking=medium, fast=on)
...
/tools/plugin#slow-plugin-tool-setup .
Console capture
...
Examples:
bash Copy code # optimized (only errors/slow) openclaw gateway # show all WS traffic (paired) openclaw gateway --verbose --ws-log compact # show all WS traffic (full meta) openclaw gateway --verbose --ws-log full
