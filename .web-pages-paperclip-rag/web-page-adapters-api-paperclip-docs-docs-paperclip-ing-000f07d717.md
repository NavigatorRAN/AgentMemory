# Adapters API | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/reference/api/adapters
- Final URL: https://docs.paperclip.ing/reference/api/adapters/
- Canonical URL: https://docs.paperclip.ing/reference/api/adapters
- Fetched at: 2026-06-23T13:39:04Z
- Content type: text/html; charset=utf-8

## Description

The adapters API is the control-plane surface for the server-side adapter registry : which agent runtimes Paperclip can talk to, how each is configured, and how external adapter pa
