# ✨ Secret Detection/Redaction (Enterprise-only) | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/secret_detection
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/secret_detection
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/secret_detection
- Fetched at: 2026-06-23T14:31:01Z
