# Gif Search — Search/download GIFs from Tenor via curl + jq | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-gif-search
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-gif-search
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/media/media-gif-search
- Fetched at: 2026-06-23T14:18:16Z
...
Search/download GIFs from Tenor via curl + jq.
Skill metadata ​
Source Bundled (installed by default) Path skills/media/gif-search Version 1.1.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags GIF , Media , Search , Tenor , API
