...
- Requested URL: https://docs.litellm.ai/docs/providers/xai
- Final URL: https://docs.litellm.ai/docs/providers/xai
- Canonical URL: https://docs.litellm.ai/docs/providers/xai
- Fetched at: 2026-06-23T14:29:28Z
...
Model Context Features xai/grok-4-1-fast-reasoning 2M tokens Reasoning , Function calling, Vision, Audio, Web search, Caching xai/grok-4-1-fast-non-reasoning 2M tokens Function calling, Vision, Audio, Web search, Caching
When to use:
...
Model Family Model Context Features Grok 4.1 xai/grok-4-1-fast-reasoning 2M Reasoning , Tools, Vision, Audio, Web search, Caching xai/grok-4-1-fast-non-reasoning 2M Tools, Vision, Audio, Web search, Caching Grok 4 xai/grok-4 256K Tools, Web search xai/grok-4-0709 256K Tools, Web search xai/grok-4-fast-reasoning 2M Reasoning , Tools, Web search xai/grok-4-fast-non-reasoning 2M Tools, Web search Grok 3 xai/grok-3 131K Tools, Web search xai/grok-3-mini 131K Tools, Web search xai/grok-3-fast-beta 131K Tools, Web search Grok Code xai/grok-code-fast 256K Reasoning , Tools, Code generation, Caching Grok 2 xai/grok-2 131K Tools, Vision xai/grok-2-vision-latest 32K Tools, Vision
Features:
