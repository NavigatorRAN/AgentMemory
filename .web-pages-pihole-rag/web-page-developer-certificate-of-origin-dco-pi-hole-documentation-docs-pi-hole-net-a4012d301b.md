# Developer Certificate of Origin (DCO) - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/guides/github/dco
- Final URL: https://docs.pi-hole.net/guides/github/dco/
- Canonical URL: https://docs.pi-hole.net/guides/github/dco/
- Fetched at: 2026-06-23T13:42:24Z
...
Contributors sign-off that they adhere to these requirements by adding a Signed-off-by line to commit messages. See this guide for how to sign-off correctly .
DCO Failures ¶
