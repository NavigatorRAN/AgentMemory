# Osint Investigation | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-osint-investigation
- Fetched at: 2026-06-23T14:20:43Z
- Content type: text/html; charset=utf-8

## Description

Public-records OSINT investigation framework — SEC EDGAR filings, USAspending contracts, Senate lobbying, OFAC sanctions, ICIJ offshore leaks, NYC property r...
...
Skill metadata ​
Source Optional — install with hermes skills install official/research/osint-investigation Path optional-skills/research/osint-investigation Version 0.1.0 Author Hermes Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) Platforms linux, macos, windows Tags osint , investigation , public-records , sec , sanctions , corporate-registry , property , courts , due-diligence , journalism Related skills domain-intel , arxiv
...
Tier Method Confidence exact Normalized strings equal after suffix/punctuation strip high fuzzy Sorted-token equality (word-bag match) medium token_overlap ≥60% token overlap, ≥2 shared tokens, tokens ≥4 chars low
