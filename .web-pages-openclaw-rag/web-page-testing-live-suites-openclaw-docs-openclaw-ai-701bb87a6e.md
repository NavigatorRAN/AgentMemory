# Testing: live suites - OpenClaw

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.openclaw.ai/help/testing-live
- Final URL: https://docs.openclaw.ai/help/testing-live
- Canonical URL: https://docs.openclaw.ai/help/testing-live
- Fetched at: 2026-06-23T14:44:26Z
...
Testing . This page covers the live (network-touching) test
...
checks.
Safe media smoke:
bash Copy code pnpm openclaw infer tts convert -- local --json \ --text "OpenClaw live smoke." \ --output /tmp/openclaw-live-smoke.mp3
Safe voice-call readiness smoke:
bash Copy code pnpm openclaw voicecall setup --json pnpm openclaw voicecall smoke --to "+15555550123"
...
bash Copy code openclaw models list openclaw models list --json
...
Example:
bash Copy code OPENCLAW_LIVE_CLI_BACKEND=1 \ OPENCLAW_LIVE_CLI_BACKEND_MODEL= "claude-cli/claude-sonnet-4-6" \ pnpm test :live src/gateway/gateway-cli-backend.live.test.ts
Cheap Gemini MCP config smoke:
bash Copy code OPENCLAW_LIVE_TEST=1 \ pnpm test :live src/agents/cli-runner/bundle-mcp.gemini.live.test.ts
...
Docker recipe:
bash Copy code pnpm test :docker:live-cli-backend
Single-provider Docker recipes:
bash Copy code pnpm test :docker:live-cli-backend:claude pnpm test :docker:live-cli-backend:claude-subscription pnpm test :docker:live-cli-backend:gemini
Notes:
...
bash Copy code OPENCLAW_LIVE_ACP_BIND=1 \ OPENCLAW_LIVE_ACP_BIND_AGENT=claude \ pnpm test :live src/gateway/gateway-acp-bind.live.test.ts
bash Copy code pnpm test :docker:live-acp-bind
Single-agent Docker recipes:
bash Copy code pnpm test :docker:live-acp-bind:claude pnpm test :docker:live-acp-bind:codex pnpm test :docker:live-acp-bind:droid pnpm test :docker:live-acp-bind:gemini pnpm test :docker:live-acp-bind:opencode
Docker notes:
...
Local recipe:
bash Copy code OPENCLAW_LIVE_CODEX_HARNESS=1 \ OPENCLAW_LIVE_CODEX_HARNESS_IMAGE_PROBE=1 \ OPENCLAW_LIVE_CODEX_HARNESS_MCP_PROBE=1 \ OPENCLAW_LIVE_CODEX_HARNESS_GUARDIAN_PROBE=1 \ OPENCLAW_LIVE_CODEX_HARNESS_MODEL=openai/gpt-5.5 \ pnpm test :live -- src/gateway/gateway-codex-harness.live.test.ts
bash Copy code pnpm test :docker:live-codex-harness
