# Lbo Model | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/finance/finance-lbo-model
- Fetched at: 2026-06-23T14:19:36Z
- Content type: text/html; charset=utf-8

## Description

Build leveraged buyout models in Excel — sources & uses, debt schedule, cash sweep, exit multiple, IRR/MOIC sensitivity
...
Skill metadata ​
Source Optional — install with hermes skills install official/finance/lbo-model Path optional-skills/finance/lbo-model Version 1.0.0 Author Anthropic (adapted by Nous Research) License Apache-2.0 Platforms linux, macos, windows Tags finance , valuation , lbo , private-equity , excel , openpyxl , modeling Related skills excel-author , pptx-author , dcf-model , 3-statement-model
