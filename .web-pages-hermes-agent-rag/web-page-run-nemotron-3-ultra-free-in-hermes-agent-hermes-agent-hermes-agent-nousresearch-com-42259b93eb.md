...
- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/run-nemotron-3-ultra-free
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/run-nemotron-3-ultra-free
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/run-nemotron-3-ultra-free
- Fetched at: 2026-06-23T14:15:16Z
- Content type: text/html; charset=utf-8

## Description

Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Hermes Agent
...
Browser didn't open / you're on a remote host (CLI)? See OAuth over SSH / Remote Hosts for port-forwarding and manual-paste workarounds.
See also ​
