...
- Requested URL: https://docs.openclaw.ai/cli/qr
- Final URL: https://docs.openclaw.ai/cli/qr
- Canonical URL: https://docs.openclaw.ai/cli/qr
- Fetched at: 2026-06-23T14:38:02Z
...
Usage
bash Copy code openclaw qr openclaw qr --setup-code-only openclaw qr --json openclaw qr --remote openclaw qr --url wss://gateway.example/ws
Options
