...
- Requested URL: https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format
- Final URL: https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format
- Canonical URL: https://hermes-agent.nousresearch.com/docs/developer-guide/trajectory-format
- Fetched at: 2026-06-23T14:14:41Z
...
File When trajectory_samples.jsonl Conversations that completed successfully ( completed=True ) failed_trajectories.jsonl Conversations that failed or were interrupted ( completed=False )
...
API Role ShareGPT from system "system" user "human" assistant "gpt" tool "tool"
Complete Example ​
"conversations" : [
"from" : "system" ,
...
Native thinking tokens ( msg["reasoning"] field from providers like
...
Empty think blocks : Every gpt turn is guaranteed to have a <think>
