# Installation | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/guides/getting-started/installation
- Final URL: https://docs.paperclip.ing/guides/getting-started/installation/
- Canonical URL: https://docs.paperclip.ing/guides/getting-started/installation
- Fetched at: 2026-06-23T13:37:49Z
...
Look at the line that says Chip or Processor
...
Go to the Paperclip Desktop releases page and download the installer for your Mac:
My Mac has… Download this file Apple Silicon (M1/M2/M3/M4) Paperclip.Desktop-[version]-arm64.dmg Intel Paperclip.Desktop-[version].dmg
...
Open the .dmg file you downloaded — it will mount like a disk image and open a window
Drag the Paperclip icon into the Applications folder
...
Port Protocol Purpose 22 TCP SSH 80 TCP HTTP (Let's Encrypt challenge + redirect) 443 TCP HTTPS
...
Type Name Value A paperclip.example.com <your server's public IPv4>
...
Install the Desktop app (see the Desktop App tab).
On the first-launch screen, choose Remote .
Enter https://paperclip.example.com as the instance URL.
Sign in with the account you created during the board claim.
