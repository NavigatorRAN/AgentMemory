...
- Requested URL: https://docs.litellm.ai/docs/completion/json_mode
- Final URL: https://docs.litellm.ai/docs/completion/json_mode
- Canonical URL: https://docs.litellm.ai/docs/completion/json_mode
- Fetched at: 2026-06-23T14:23:13Z
...
"required": ["name", "age"],
Model Behavior ​
Model Format Used additionalProperties Support Gemini 2.0+ responseJsonSchema (JSON Schema) ✅ Yes Gemini 1.5 responseSchema (OpenAPI) ❌ No
