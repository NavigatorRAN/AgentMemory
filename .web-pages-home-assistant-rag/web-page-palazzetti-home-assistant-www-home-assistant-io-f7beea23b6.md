...
- Requested URL: https://www.home-assistant.io/integrations/palazzetti
- Final URL: https://www.home-assistant.io/integrations/palazzetti
- Canonical URL: https://www.home-assistant.io/integrations/palazzetti/
- Fetched at: 2026-06-28T03:07:15Z
- Content type: text/html; charset=UTF-8

## Description

Instructions on how to integrate Palazzetti within Home Assistant.
...
The Palazzetti integration Integrations connect and integrate Home Assistant with your devices, services, and more. [Learn more] integrates the Palazzetti
stoves equipped with a Connection Box .
It is accessing the device’s local API. WPalaControl
...
Palazzetti can be auto-discovered by Home Assistant. If an instance was found,
...
alias : " Lower the temperature when last person leaves" description : " Lower the temperature when last person leaves the home" mode : single triggers : - trigger : state entity_id : - zone.home to : 0 actions : - action : climate.set_temperature data : temperature : 16 target : entity_id : climate.my_stove
...
The Palazzetti device was introduced in Home Assistant 2024.11, and it's used by
