# Llava — Large Language and Vision Assistant | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-llava
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-llava
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-llava
- Fetched at: 2026-06-23T14:20:01Z
...
Skill metadata ​
Source Optional — install with hermes skills install official/mlops/llava Path optional-skills/mlops/llava Version 1.0.0 Author Orchestra Research License MIT Dependencies transformers , torch , pillow Platforms linux, macos, windows Tags LLaVA , Vision-Language , Multimodal , Visual Question Answering , Image Chat , CLIP , Vicuna , Conversational AI , Instruction Tuning , VQA
