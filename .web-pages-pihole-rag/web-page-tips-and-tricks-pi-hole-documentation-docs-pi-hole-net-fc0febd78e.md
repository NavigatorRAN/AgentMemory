...
- Requested URL: https://docs.pi-hole.net/docker/tips-and-tricks
- Final URL: https://docs.pi-hole.net/docker/tips-and-tricks/
- Canonical URL: https://docs.pi-hole.net/docker/tips-and-tricks/
- Fetched at: 2026-06-23T13:41:39Z
...
Example netplan:
network : ethernets : ens160 : dhcp4 : true dhcp4-overrides : use-dns : false nameservers : addresses : [ 127.0.0.1 ] version : 2
...
To exclude the Pi-hole container from Watchtower's auto-update system take a look at Full Exclude in Watchtower's docs.
