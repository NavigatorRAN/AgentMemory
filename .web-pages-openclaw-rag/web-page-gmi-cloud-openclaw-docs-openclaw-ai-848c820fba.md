...
- Requested URL: https://docs.openclaw.ai/providers/gmi
- Final URL: https://docs.openclaw.ai/providers/gmi
- Canonical URL: https://docs.openclaw.ai/providers/gmi
- Fetched at: 2026-06-23T14:55:20Z
...
bash Copy code openclaw plugins install @openclaw/gmi-provider openclaw gateway restart
Then run:
bash Copy code openclaw onboard --auth-choice gmi-api-key
Or set:
bash Copy code export GMI_API_KEY= "<your-gmi-api-key>" # pragma: allowlist secret
Defaults
Provider: gmi
...
bash Copy code openclaw models list --provider gmi
Troubleshooting
