# Video Generation Provider Plugins | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin
- Final URL: https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin
- Canonical URL: https://hermes-agent.nousresearch.com/docs/developer-guide/video-gen-provider-plugin
- Fetched at: 2026-06-23T14:14:42Z
...
Bundled — <repo>/plugins/video_gen/<name>/ (auto-loaded with kind: backend )
User — ~/.hermes/plugins/video_gen/<name>/ (opt-in via plugins.enabled )
...
model= keyword from the tool call
<PROVIDER>_VIDEO_MODEL env var
video_gen.<provider>.model in config.yaml
video_gen.model in config.yaml (when it's one of your IDs)
