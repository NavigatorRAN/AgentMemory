...
- Requested URL: https://docs.openclaw.ai/web/tui
- Final URL: https://docs.openclaw.ai/web/tui
- Canonical URL: https://docs.openclaw.ai/web/tui
- Fetched at: 2026-06-23T14:58:39Z
...
Open the TUI.
bash Copy code openclaw tui
Type a message and press Enter.
Remote Gateway:
bash Copy code openclaw tui --url ws://<host>:<port> --token <gateway-token>
Use --password if your Gateway uses password auth.
Local mode
Run the TUI without a Gateway:
bash Copy code openclaw chat # or openclaw tui -- local
Notes:
...
bash Copy code openclaw config set tui.footer.showRemoteHost true
...
text Copy code Compare my gateway auth config with the docs and suggest the smallest fix.
...
Apply narrow changes with openclaw config set or openclaw configure , then rerun !openclaw config validate .
If Doctor recommends an automatic migration or repair, review it and run !openclaw doctor --fix .
Tips:
