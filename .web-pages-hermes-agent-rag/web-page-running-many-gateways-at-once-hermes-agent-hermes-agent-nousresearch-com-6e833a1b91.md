# Running Many Gateways at Once | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/multi-profile-gateways
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/multi-profile-gateways
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/multi-profile-gateways
- Fetched at: 2026-06-23T14:17:25Z
- Content type: text/html; charset=utf-8

## Description

Operate multiple profiles — each with its own bot tokens,
...
never clash:
Platform Path macOS ~/Library/LaunchAgents/ai.hermes.gateway-<profile>.plist Linux ~/.config/systemd/user/hermes-gateway-<profile>.service
...
pkill caffeinate
Flag Effect -d block display sleep -i block idle system sleep (default) -m block disk sleep -s block system sleep (AC-powered Macs only) -u simulate user activity (prevents screen lock) -t N auto-exit after N seconds -w P exit when PID P exits
Lid-close still sleeps the Mac
