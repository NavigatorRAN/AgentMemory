...
- Requested URL: https://docs.openclaw.ai/providers/novita
- Final URL: https://docs.openclaw.ai/providers/novita
- Canonical URL: https://docs.openclaw.ai/providers/novita
- Fetched at: 2026-06-23T14:55:37Z
...
bash Copy code openclaw onboard --auth-choice novita-api-key
Or set:
bash Copy code export NOVITA_API_KEY= "<your-novita-api-key>" # pragma: allowlist secret
Defaults
Provider: novita
...
bash Copy code openclaw models list --provider novita
Troubleshooting
