...
- Requested URL: https://docs.litellm.ai/docs/providers/huggingface_rerank
- Final URL: https://docs.litellm.ai/docs/providers/huggingface_rerank
- Canonical URL: https://docs.litellm.ai/docs/providers/huggingface_rerank
- Fetched at: 2026-06-23T14:28:05Z
...
Copy as Markdown
HuggingFace Rerank allows you to use reranking models hosted on Hugging Face infrastructure or your custom endpoints to reorder documents based on their relevance to a query.
Property Details Description HuggingFace Rerank enables semantic reranking of documents using models hosted on Hugging Face infrastructure or custom endpoints. Provider Route on LiteLLM huggingface/ in model name Provider Doc Hugging Face Hub ↗
Quick Start ​
LiteLLM Python SDK ​
