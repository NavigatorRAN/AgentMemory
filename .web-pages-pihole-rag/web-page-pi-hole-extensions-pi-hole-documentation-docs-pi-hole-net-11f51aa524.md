# Pi-hole extensions - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/regex/pi-hole
- Final URL: https://docs.pi-hole.net/regex/pi-hole/
- Canonical URL: https://docs.pi-hole.net/regex/pi-hole/
- Fetched at: 2026-06-23T13:43:45Z
...
Multiple characters: [abc] matches a , b , and c .
Character ranges: [0-9] matches any decimal digit.
Character classes:
