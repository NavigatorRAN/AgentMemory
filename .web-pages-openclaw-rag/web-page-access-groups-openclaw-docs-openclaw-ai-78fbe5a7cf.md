...
- Requested URL: https://docs.openclaw.ai/channels/access-groups
- Final URL: https://docs.openclaw.ai/channels/access-groups
- Canonical URL: https://docs.openclaw.ai/channels/access-groups
- Fetched at: 2026-06-23T14:35:55Z
...
json5 Copy code { accessGroups : { operators : { type : "message.senders" , members : { "*" : [ "global-owner-id" ], discord : [ "discord:123456789012345678" ], telegram : [ "987654321" ], whatsapp : [ "+15551234567" ], }, }, }, }
Member lists are keyed by message-channel id:
Key Meaning "*" Shared entries checked for every message channel that references group. discord Entries checked only for Discord allowlist matching. telegram Entries checked only for Telegram allowlist matching. whatsapp Entries checked only for WhatsApp allowlist matching.
...
json5 Copy code { accessGroups : { operators : { type : "message.senders" , members : { discord : [ "discord:123456789012345678" ], telegram : [ "987654321" ], }, }, }, channels : { discord : { dmPolicy : "allowlist" , allowFrom : [ "accessGroup:operators" ], }, telegram : { dmPolicy : "allowlist" , allowFrom : [ "accessGroup:operators" ], }, }, }
Group sender allowlist example:
json5 Copy code { accessGroups : { oncall : { type : "message.senders" , members : { whatsapp : [ "+15551234567" ], googlechat : [ "users/1234567890" ], }, }, }, channels : { whatsapp : { groupPolicy : "allowlist" , groupAllowFrom : [ "accessGroup:oncall" ], }, googlechat : { spaces : { "spaces/AAA" : { users : [ "accessGroup:oncall" ], }, }, }, }, }
You can mix groups and direct entries:
json5 Copy code { channels : { discord : { dmPolicy : "allowlist" , allowFrom : [ "accessGroup:operators" , "discord:123456789012345678" ], }, }, }
...
typescript Copy code const state = await resolveAccessGroupAllowFromState ({ accessGroups : cfg. accessGroups , allowFrom : channelConfig. allowFrom , channel : "my-channel" , accountId : "default" , senderId, isSenderAllowed, });
