# Design Md — Author/validate/export Google's DESIGN | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-design-md
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-design-md
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-design-md
- Fetched at: 2026-06-23T14:17:52Z
- Content type: text/html; charset=utf-8

## Description

Author/validate/export Google's DESIGN
...
Skill metadata ​
Source Bundled (installed by default) Path skills/creative/design-md Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags design , design-system , tokens , ui , accessibility , wcag , tailwind , dtcg , google Related skills popular-web-designs , claude-design , excalidraw , architecture-diagram
...
Token types ​
Type Format Example Color # + hex (sRGB) "#1A1C1E" Dimension number + unit ( px , em , rem ) 48px , -0.02em Token reference {path.to.token} {colors.primary} Typography object with fontFamily , fontSize , fontWeight , lineHeight , letterSpacing , fontFeature , fontVariation see above
