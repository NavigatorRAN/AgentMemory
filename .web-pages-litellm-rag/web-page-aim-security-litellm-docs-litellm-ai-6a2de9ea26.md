# Aim Security | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/aim_security
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/aim_security
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/aim_security
...
by installing Aim Outpost prior to creating the guard.
