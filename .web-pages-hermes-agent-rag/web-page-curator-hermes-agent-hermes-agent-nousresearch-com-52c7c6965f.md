...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/curator
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/curator
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/features/curator
- Fetched at: 2026-06-23T14:16:08Z
...
Enough time has passed since the last curator run ( interval_hours , default 7 days ), and
The agent has been idle long enough ( min_idle_hours , default 2 hours ).
...
are true:
Its name is not in ~/.hermes/skills/.bundled_manifest (bundled skills shipped with the repo).
Its name is not in ~/.hermes/skills/.hub/lock.json (hub-installed skills).
Its .usage.json entry has "created_by": "agent" or "agent_created": true .
