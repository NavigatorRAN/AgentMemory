# Teams Meeting Pipeline | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline
- Fetched at: 2026-06-23T14:18:39Z
...
Operate the Teams meeting summary pipeline via Hermes CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions.
Skill metadata ​
Source Bundled (installed by default) Path skills/productivity/teams-meeting-pipeline Version 1.1.0 Author Hermes Agent + Teknium License MIT Tags Teams , Microsoft Graph , Meetings , Productivity , Operations
...
hermes teams-pipeline renew-subscription < sub-id > --expiration < iso-860 1 >
