# Automate Anything with Cron | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/automate-with-cron
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/automate-with-cron
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/automate-with-cron
- Fetched at: 2026-06-23T14:14:51Z
...
One-shot from a script that's already running (CI step, post-commit hook, deploy script, externally-scheduled monitor): use hermes send to pipe stdout or a file straight to Telegram / Discord / Slack / etc. without setting up a cron entry.
...
Target Example Use case origin --deliver origin Same chat that created the job (default) local --deliver local Save to local file only telegram --deliver telegram Your Telegram home channel discord --deliver discord Your Discord home channel slack --deliver slack Your Slack home channel Specific chat --deliver telegram:-1001234567890 A specific Telegram group Threaded --deliver telegram:-1001234567890:17585 A specific Telegram topic thread
Tips ​
