---
source_url: "https://www.home-assistant.io/integrations/home_connect"
final_url: "https://www.home-assistant.io/integrations/home_connect"
canonical_url: "https://www.home-assistant.io/integrations/home_connect/"
source_handle: "web:www-home-assistant-io:71ffdab2d2b1"
source_section: "integrations-home-connect"
collection: "home-assistant-docs"
doc_type: "api-reference"
language: "en"
import_run_id: "home-assistant-docs-legacy-backfill"
content_hash: "a15ffbbfd5547fef2c2c4a9a61b2112d4843149ff1bc134a9cafe4324031a728"
memory_event_id: ""
wiki_slug: ""
...
- Requested URL: https://www.home-assistant.io/integrations/home_connect
- Final URL: https://www.home-assistant.io/integrations/home_connect
- Canonical URL: https://www.home-assistant.io/integrations/home_connect/
- Fetched at: 2026-06-28T02:49:14Z
- Content type: text/html; charset=UTF-8

## Description

Instructions on how to set up the Home Connect integration within Home Assistant.
...
The Home Connect integration Integrations connect and integrate Home Assistant with your devices, services, and more. [Learn more] allows users to integrate their home appliances supporting the Home Connect standard for Bosch and Siemens using the official cloud API .
...
Home Connect can be auto-discovered by Home Assistant. If an instance was found,
...
Some devices only have the state on and turn off is not supported by the appliance, check power state availability at Home Connect API documentation for more information.
Child lock :
...
Data attribute Optional Description device_id no ID of the device. b_s_h_common_option_finish_in_relative yes Defines when the program should end, in seconds from now. For example: a value of 9000 means in 2 h 30 min. b_s_h_common_option_start_in_relative yes Defines when the program should start, in seconds from now. For example: a value of 9000 means in 2 h 30 min.
The home_connect.change_setting action changes a setting.
Data attribute Optional Description device_id no Id of a device associated with the home appliance. key no Key of the setting. value no Value of the setting.
Get started with these automation examples
Example YAML configuration
alias : " Notify when program ends" triggers : - trigger : state entity_id : - sensor.appliance_operation_state to : finished actions : - action : notify.notify data : message : " The appliance has finished the program."
...
alias : " Start program when electricity is cheap" triggers : - trigger : state entity_id : sensor.electricity_price to : " 0.10" conditions : - condition : state entity_id : sensor.diswasher_door state : closed actions : - if : - condition : time after : ' 22:00:00' before : ' 06:00:00' then : - action : home_connect.set_program_and_options data : device_id : " your_device_id" affects_to : " active_program" program : " dishcare_dishwasher_program_eco_50" dishcare_dishwasher_option_silence_on_demand : true else : - action : home_connect.set_program_and_options data : device_id : " your_device_id" affects_to : " active_program" program : " dishcare_dishwasher_program_eco_50"
...
Symptom: I tried to configure the Home Connect integration, but it failed with the message Error while obtaining access token. Description
...
Home Connect service and contact
Home Connect developer Help & Support
...
{ "data" : { "connected" : false , "status" : {}, "programs" : null } }
...
The Home Connect hub was introduced in Home Assistant 0.110, and it's used by
4.9% of the active installations.
