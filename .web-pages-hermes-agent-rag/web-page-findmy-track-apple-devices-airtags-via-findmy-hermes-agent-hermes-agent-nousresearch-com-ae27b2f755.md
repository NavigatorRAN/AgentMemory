...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/apple/apple-findmy
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/apple/apple-findmy
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/apple/apple-findmy
- Fetched at: 2026-06-23T14:17:35Z
- Content type: text/html; charset=utf-8

## Description

Track Apple devices/AirTags via FindMy
...
Skill metadata ​
Source Bundled (installed by default) Path skills/apple/findmy Version 1.0.0 Author Hermes Agent License MIT Platforms macos Tags FindMy , AirTag , location , tracking , macOS , Apple
