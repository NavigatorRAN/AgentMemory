# 🪢 Langfuse - Logging LLM Input/Output | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/observability/langfuse_integration
- Final URL: https://docs.litellm.ai/docs/observability/langfuse_integration
- Canonical URL: https://docs.litellm.ai/docs/observability/langfuse_integration
...
info
For Langfuse v3, we recommend using the Langfuse OTEL integration.
...
Trace & Generation Parameters ​ Trace Specific Parameters ​
