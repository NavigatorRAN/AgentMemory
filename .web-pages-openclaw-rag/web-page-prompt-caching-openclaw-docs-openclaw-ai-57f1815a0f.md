...
- Requested URL: https://docs.openclaw.ai/reference/prompt-caching
- Final URL: https://docs.openclaw.ai/reference/prompt-caching
- Canonical URL: https://docs.openclaw.ai/reference/prompt-caching
- Fetched at: 2026-06-23T14:56:30Z
...
yaml Copy code agents: defaults: params: cacheRetention: "long" # none | short | long
Override per-model:
yaml Copy code agents: defaults: models: "anthropic/claude-opus-4-6": params: cacheRetention: "short" # none | short | long
Per-agent override:
yaml Copy code agents: list: - id: "alerts" params: cacheRetention: "none"
Config merge order:
...
yaml Copy code agents: defaults: contextPruning: mode: "cache-ttl" ttl: "1h"
See Session Pruning for full behavior.
Heartbeat keep-warm
Heartbeat can keep cache windows warm and reduce repeated cache writes after idle gaps.
yaml Copy code agents: defaults: heartbeat: every: "55m"
...
yaml Copy code agents: defaults: model: primary: "anthropic/claude-opus-4-6" models: "anthropic/claude-opus-4-6": params: cacheRetention: "long" list: - id: "research" default: true heartbeat: every: "55m" - id: "alerts" params: cacheRetention: "none"
Cost-first baseline
...
sh Copy code OPENCLAW_LIVE_TEST=1 OPENCLAW_LIVE_CACHE_TEST=1 pnpm test :live:cache
...
yaml Copy code diagnostics: cacheTrace: enabled: true filePath: "~/.openclaw/logs/cache-trace.jsonl" # optional includeMessages: false # default true includePrompt: false # default true includeSystem: false # default true
Defaults:
