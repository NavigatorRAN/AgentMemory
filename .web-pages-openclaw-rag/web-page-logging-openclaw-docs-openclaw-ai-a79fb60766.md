...
- Requested URL: https://docs.openclaw.ai/logging
- Final URL: https://docs.openclaw.ai/logging
- Canonical URL: https://docs.openclaw.ai/logging
- Fetched at: 2026-06-23T14:46:59Z
...
json Copy code { "logging" : { "file" : "/path/to/openclaw.log" } }
How to read logs
...
See Control UI for how to open it.
Channel-only logs
To filter channel activity (WhatsApp/Telegram/etc), use:
bash Copy code openclaw channels logs --channel whatsapp
Log formats
File logs (JSONL)
...
Examples:
bash Copy code openclaw gateway openclaw gateway --verbose --ws-log compact openclaw gateway --verbose --ws-log full
Configuring logging
All logging configuration lives under logging in ~/.openclaw/openclaw.json .
json Copy code { "logging" : { "level" : "info" , "file" : "/tmp/openclaw/openclaw-YYYY-MM-DD.log" , "consoleLevel" : "info" , "consoleStyle" : "pretty" , "redactSensitive" : "tools" , "redactPatterns" : [ "sk-.*" ] } }
Log levels
...
all logs to debug :
bash Copy code OPENCLAW_DEBUG_MODEL_TRANSPORT=1 openclaw gateway OPENCLAW_DEBUG_MODEL_PAYLOAD=tools OPENCLAW_DEBUG_SSE=events openclaw gateway
Available flags:
