...
- Requested URL: https://docs.litellm.ai/docs/benchmarks
- Final URL: https://docs.litellm.ai/docs/benchmarks
- Canonical URL: https://docs.litellm.ai/docs/benchmarks
- Fetched at: 2026-06-23T14:22:55Z
...
Performance Metrics ​ Type Name Median (ms) 95%ile (ms) 99%ile (ms) Average (ms) Current RPS POST /chat/completions 200 630 1200 262.46 1035.7 Custom LiteLLM Overhead Duration (ms) 12 29 43 14.74 1035.7 Aggregated 100 430 930 138.6 2071.4
4 Instances ​
Type Name Median (ms) 95%ile (ms) 99%ile (ms) Average (ms) Current RPS POST /chat/completions 100 150 240 111.73 1170 Custom LiteLLM Overhead Duration (ms) 2 8 13 3.32 1170 Aggregated 77 130 180 57.53 2340 Key Findings ​
...
Hosted endpoint : Use our free hosted fake endpoint at https://exampleopenaiendpoint-production.up.railway.app/
Self-hosted : Set up your own fake OpenAI proxy server using github.com/BerriAI/example_openai_endpoint
...
Performance Metrics ​
Metric Value Median latency 59 ms p95 latency 67 ms p99 latency 99 ms Average latency 63 ms RPS 1,207
Test Setup ​
Category Specification Load Testing Locust: 1,000 concurrent users, 500 ramp-up System 4 vCPUs, 8 GB RAM, 4 workers, 4 instances Database PostgreSQL (Redis unused)
...
Workload CPU RAM Storage Connections 1-2K RPS 4-8 cores 16GB 200GB SSD (3000+ IOPS) 100-200 2-5K RPS 8 cores 16-32GB 500GB SSD (5000+ IOPS) 200-500 5K+ RPS 16+ cores 32-64GB 1TB+ SSD (10000+ IOPS) 500+
...
Workload CPU RAM 1-2K RPS 2-4 cores 8GB 2-5K RPS 4 cores 16GB 5K+ RPS 8+ cores 32GB+
...
Metric Basic Litellm Proxy LiteLLM Proxy with GCS Bucket Logging RPS 1133.2 1137.3 Median Latency (ms) 140 138
LangSmith logging ​
Using LangSmith has no impact on latency, RPS compared to Basic Litellm Proxy
Metric Basic Litellm Proxy LiteLLM Proxy with LangSmith RPS 1133.2 1135 Median Latency (ms) 140 132
Machine Spec used for testing
Configuration
2 Instance LiteLLM Proxy
4 Instances
