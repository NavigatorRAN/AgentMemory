...
- Requested URL: https://docs.openclaw.ai/channels/pairing
- Final URL: https://docs.openclaw.ai/channels/pairing
- Canonical URL: https://docs.openclaw.ai/channels/pairing
- Fetched at: 2026-06-23T14:36:28Z
...
Approve a sender
bash Copy code openclaw pairing list telegram openclaw pairing approve telegram <CODE>
...
json5 Copy code { accessGroups : { operators : { type : "message.senders" , members : { discord : [ "discord:123456789012345678" ], telegram : [ "987654321" ], whatsapp : [ "+15551234567" ], }, }, }, channels : { telegram : { dmPolicy : "allowlist" , allowFrom : [ "accessGroup:operators" ] }, whatsapp : { groupPolicy : "allowlist" , groupAllowFrom : [ "accessGroup:operators" ] }, }, }
...
Back in Telegram: /pair pending (review request IDs, role, and scopes), then approve.
