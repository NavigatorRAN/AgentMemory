# ✨ [BETA] LiteLLM Managed Files with Finetuning | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/managed_finetuning
- Final URL: https://docs.litellm.ai/docs/proxy/managed_finetuning
- Canonical URL: https://docs.litellm.ai/docs/proxy/managed_finetuning
- Fetched at: 2026-06-23T14:31:21Z
...
Property Value Comments Proxy ✅ SDK ❌ Requires postgres DB for storing file ids. Available across all Batch providers ✅ Supported endpoints /fine_tuning/jobs
Overview ​
Use this to:
