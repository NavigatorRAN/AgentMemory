# Pinggy Tunnel — Zero-install localhost tunnels over SSH via Pinggy | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-pinggy-tunnel
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-pinggy-tunnel
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/devops/devops-pinggy-tunnel
- Fetched at: 2026-06-23T14:19:26Z
...
Zero-install localhost tunnels over SSH via Pinggy.
Skill metadata ​
Source Optional — install with hermes skills install official/devops/pinggy-tunnel Path optional-skills/devops/pinggy-tunnel Version 0.1.0 Author Teknium (teknium1), Hermes Agent License MIT Platforms linux, macos, windows Tags Pinggy , Tunnel , Networking , SSH , Webhook , Localhost Related skills cloudflared-quick-tunnel , webhook-subscriptions
