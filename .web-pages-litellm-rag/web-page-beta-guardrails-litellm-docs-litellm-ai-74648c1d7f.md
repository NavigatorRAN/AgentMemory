# 🛡️ [Beta] Guardrails | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/old_guardrails
- Final URL: https://docs.litellm.ai/docs/old_guardrails
- Canonical URL: https://docs.litellm.ai/docs/old_guardrails
...
example - we defined prompt_injection , hide_secrets_guard on step 1
This will
