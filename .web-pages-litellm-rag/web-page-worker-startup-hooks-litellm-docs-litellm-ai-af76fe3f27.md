# Worker Startup Hooks | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/worker_startup_hooks
- Final URL: https://docs.litellm.ai/docs/proxy/worker_startup_hooks
- Canonical URL: https://docs.litellm.ai/docs/proxy/worker_startup_hooks
- Fetched at: 2026-06-23T14:32:36Z
- Content type: text/html; charset=utf-8

## Description

Use LITELLMWORKERSTARTUPHOOKS to run custom initialization functions in **each worker process** during proxy startup. This is essential when using multi-worker deployments (--numworkers > 1) with libraries that require per-process initialization, such as gflags.
...
python-gflags ( gflags.FLAGS )
absl-py flags ( absl.flags.FLAGS )
...
Reference ​
Environment Variable Description LITELLM_WORKER_STARTUP_HOOKS Comma-separated module.path:function_name callables to run in each worker on startup
