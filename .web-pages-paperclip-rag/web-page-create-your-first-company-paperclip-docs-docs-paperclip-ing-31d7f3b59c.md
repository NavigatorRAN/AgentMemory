# Create Your First Company | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/guides/getting-started/your-first-company
- Final URL: https://docs.paperclip.ing/guides/getting-started/your-first-company/
- Canonical URL: https://docs.paperclip.ing/guides/getting-started/your-first-company
- Fetched at: 2026-06-23T13:37:53Z
- Content type: text/html; charset=utf-8

## Description

A Company in Paperclip is the container for everything: your goal, your team of agents, all the tasks they work through, and the budget that keeps spending under control. Before an
...
Before you start
Make sure Paperclip is installed and running. If you haven't done that yet, start with the Installation guide .
Click "New Company"
...
Write your company goal (optional)
...
Instead of… Write… "Grow the business" "Reach $10,000/month in recurring revenue by Q3" "Do content marketing" "Publish 4 high-quality blog posts per week and grow organic traffic to 10,000 monthly visitors by June" "Build an app" "Ship a working MVP with user authentication, a core feature, and a landing page by May 1st"
