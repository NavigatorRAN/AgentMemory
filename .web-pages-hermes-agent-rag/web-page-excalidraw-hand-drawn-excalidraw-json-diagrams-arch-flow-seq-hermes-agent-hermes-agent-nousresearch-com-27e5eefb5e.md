# Excalidraw — Hand-drawn Excalidraw JSON diagrams (arch, flow, seq) | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-excalidraw
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-excalidraw
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-excalidraw
- Fetched at: 2026-06-23T14:17:53Z
...
Hand-drawn Excalidraw JSON diagrams (arch, flow, seq).
Skill metadata ​
Source Bundled (installed by default) Path skills/creative/excalidraw Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos, windows Tags Excalidraw , Diagrams , Flowcharts , Architecture , Visualization , JSON
...
Use Fill Color Hex Primary / Input Light Blue #a5d8ff Success / Output Light Green #b2f2bb Warning / External Light Orange #ffd8a8 Processing / Special Light Purple #d0bfff Error / Critical Light Red #ffc9c9 Notes / Decisions Light Yellow #fff3bf Storage / Data Light Teal #c3fae8
Tips ​
