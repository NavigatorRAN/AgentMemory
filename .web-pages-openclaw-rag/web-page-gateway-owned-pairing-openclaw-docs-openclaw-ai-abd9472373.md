...
- Requested URL: https://docs.openclaw.ai/gateway/pairing
- Final URL: https://docs.openclaw.ai/gateway/pairing
- Canonical URL: https://docs.openclaw.ai/gateway/pairing
- Fetched at: 2026-06-23T14:44:01Z
...
bash Copy code openclaw nodes pending openclaw nodes approve <requestId> openclaw nodes reject <requestId> openclaw nodes status openclaw nodes remove --node < id |name|ip> openclaw nodes rename --node < id |name|ip> --name "Living Room iPad"
...
a same-host connect. See Trusted Proxy Auth for
