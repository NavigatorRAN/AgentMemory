...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/ntfy
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/ntfy
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/messaging/ntfy
- Fetched at: 2026-06-23T14:17:03Z
...
Pick a topic name: hermes-myname-2026
On your phone: install the ntfy app , tap + , enter hermes-myname-2026
On the host:
echo 'NTFY_TOPIC=hermes-myname-2026' >> ~/.hermes/.env
echo 'NTFY_ALLOWED_USERS=hermes-myname-2026' >> ~/.hermes/.env
hermes gateway restart
From the ntfy app, send a message to the topic. The agent's reply lands as a push notification.
