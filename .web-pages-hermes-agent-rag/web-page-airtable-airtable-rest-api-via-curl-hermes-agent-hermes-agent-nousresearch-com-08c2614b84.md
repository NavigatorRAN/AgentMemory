# Airtable — Airtable REST API via curl | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-airtable
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-airtable
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-airtable
- Fetched at: 2026-06-23T14:18:30Z
...
Skill metadata ​
Source Bundled (installed by default) Path skills/productivity/airtable Version 1.1.0 Author community License MIT Platforms linux, macos, windows Tags Airtable , Productivity , Database , API
