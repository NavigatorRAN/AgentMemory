...
RAG MCP transport, share extension, watched folders, inline source rendering, retry/backoff controls, transcript/web ingestion adapters, and graph rendering are planned next.
