# Service Accounts | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/service_accounts
- Final URL: https://docs.litellm.ai/docs/proxy/service_accounts
- Canonical URL: https://docs.litellm.ai/docs/proxy/service_accounts
- Fetched at: 2026-06-23T14:32:04Z
...
Feature Regular Key Service Account Key user_id Optional Always null team_id Optional Required Applied limits User + Team limits Team limits only Key deleted when user is deleted? Yes No — persists service_account_id in metadata Not set Immutable once set team_member_key_duration Inherits Does not inherit
Budgets & Limits ​
...
Operation Result Overwrite with a different value 400 error Set to null explicitly 400 error Send metadata: null (would clear it) 400 error Omit metadata entirely on update Safe — existing value is preserved Resend the same value Allowed (no-op)
