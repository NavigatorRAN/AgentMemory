# Webserver - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/ftldns/webserver
- Final URL: https://docs.pi-hole.net/ftldns/webserver/
- Canonical URL: https://docs.pi-hole.net/ftldns/webserver/
- Fetched at: 2026-06-23T13:42:11Z
...
FTL comes with the embedded webserver CivetWeb supporting Lua server pages (LSP). This means you can write dynamic web content directly using Lua scripts, similar to how PHP is used in traditional web development. Lua offers several advantages over PHP in the embedded context:
