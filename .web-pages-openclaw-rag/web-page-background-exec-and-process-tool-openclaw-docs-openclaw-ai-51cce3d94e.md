...
- Requested URL: https://docs.openclaw.ai/gateway/background-process
- Final URL: https://docs.openclaw.ai/gateway/background-process
- Canonical URL: https://docs.openclaw.ai/gateway/background-process
- Fetched at: 2026-06-23T14:43:28Z
...
json Copy code { "tool" : "exec" , "command" : "sleep 5 && echo done" , "yieldMs" : 1000 } json Copy code { "tool" : "process" , "action" : "poll" , "sessionId" : "<id>" }
Inspect an interactive session before sending input:
json Copy code { "tool" : "process" , "action" : "log" , "sessionId" : "<id>" }
Start immediately in background:
json Copy code { "tool" : "exec" , "command" : "npm run build" , "background" : true }
Send stdin:
json Copy code { "tool" : "process" , "action" : "write" , "sessionId" : "<id>" , "data" : "y\n" }
Send PTY keys:
json Copy code { "tool" : "process" , "action" : "send-keys" , "sessionId" : "<id>" , "keys" : [ "C-c" ] }
Submit current line:
