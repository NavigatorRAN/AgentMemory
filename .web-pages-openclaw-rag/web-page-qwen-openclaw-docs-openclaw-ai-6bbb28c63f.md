...
- Requested URL: https://docs.openclaw.ai/providers/qwen
- Final URL: https://docs.openclaw.ai/providers/qwen
- Canonical URL: https://docs.openclaw.ai/providers/qwen
- Fetched at: 2026-06-23T14:55:51Z
...
bash Copy code openclaw plugins install @openclaw/qwen-provider openclaw gateway restart
Getting started
...
bash Copy code openclaw onboard --auth-choice qwen-api-key
For the China endpoint:
bash Copy code openclaw onboard --auth-choice qwen-api-key-cn
Set a default model
json5 Copy code { agents : { defaults : { model : { primary : "qwen/qwen3.5-plus" }, }, }, }
Verify the model is available
bash Copy code openclaw models list --provider qwen
Note
...
bash Copy code openclaw onboard --auth-choice qwen-standard-api-key-cn
Qwen OAuth / Portal
Best for: a Qwen Portal token against https://portal.qwen.ai/v1 .
See Qwen OAuth / Portal for the dedicated provider
page and migration notes.
Provide your portal token
bash Copy code openclaw onboard --auth-choice qwen-oauth
json5 Copy code { agents : { defaults : { model : { primary : "qwen-oauth/qwen3.5-plus" }, }, }, }
bash Copy code openclaw models list --provider qwen-oauth
...
Manage keys: home.qwencloud.com/api-keys |
Docs: docs.qwencloud.com
Built-in catalog
...
Model ref Input Context Notes qwen/qwen3.5-plus text, image 1,000,000 Default model qwen/qwen3.6-plus text, image 1,000,000 Prefer Standard endpoints when you need this model qwen/qwen3-max-2026-01-23 text 262,144 Qwen Max line qwen/qwen3-coder-next text 262,144 Coding qwen/qwen3-coder-plus text 1,000,000 Coding qwen/MiniMax-M2.5 text 1,000,000 Reasoning enabled qwen/glm-5 text 202,752 GLM qwen/glm-4.7 text 202,752 GLM qwen/kimi-k2.5 text, image 262,144 Moonshot AI via Alibaba qwen-oauth/qwen3.5-plus text, image 1,000,000 Qwen Portal default
...
json5 Copy code { agents : { defaults : { videoGenerationModel : { primary : "qwen/wan2.6-t2v" }, }, }, } Note
...
Property Value Model qwen-vl-max-latest Supported input Images, video
