# Using your MCP | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/mcp_usage
- Final URL: https://docs.litellm.ai/docs/mcp_usage
- Canonical URL: https://docs.litellm.ai/docs/mcp_usage
- Fetched at: 2026-06-23T14:24:46Z
...
Python SDK Example with allowed_tools
api_key = "sk-1234" ,
