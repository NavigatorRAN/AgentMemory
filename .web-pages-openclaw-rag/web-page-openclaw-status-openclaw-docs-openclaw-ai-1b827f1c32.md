...
- Requested URL: https://docs.openclaw.ai/cli/status
- Final URL: https://docs.openclaw.ai/cli/status
- Canonical URL: https://docs.openclaw.ai/cli/status
- Fetched at: 2026-06-23T14:38:10Z
...
bash Copy code openclaw status openclaw status --all openclaw status --deep openclaw status --usage
Notes:
