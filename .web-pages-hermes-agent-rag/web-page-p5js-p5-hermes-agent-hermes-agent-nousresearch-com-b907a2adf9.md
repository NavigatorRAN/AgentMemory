# P5Js — p5 | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-p5js
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-p5js
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/creative/creative-p5js
- Fetched at: 2026-06-23T14:17:57Z
...
Skill metadata ​
Source Bundled (installed by default) Path skills/creative/p5js Version 1.0.0 Platforms linux, macos, windows Tags creative-coding , generative-art , p5js , canvas , interactive , visualization , webgl , shaders , animation Related skills ascii-video , manim-video , excalidraw
