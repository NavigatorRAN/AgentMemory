...
- Requested URL: https://docs.openclaw.ai/cli/memory
- Final URL: https://docs.openclaw.ai/cli/memory
- Canonical URL: https://docs.openclaw.ai/cli/memory
- Fetched at: 2026-06-23T14:37:48Z
- Content type: text/html; charset=utf-8

## Description

CLI reference for `openclaw memory` (status/index/search/promote/promote-explain/rem-harness)
...
bash Copy code openclaw memory promote [--apply] [-- limit <n>] [--include-promoted]
...
bash Copy code openclaw memory promote-explain <selector> [--agent < id >] [--include-promoted] [--json]
...
bash Copy code openclaw memory rem-harness [--agent < id >] [--include-promoted] [--json]
