# Run Hermes Locally with Ollama — Zero API Cost | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/local-ollama-setup
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/local-ollama-setup
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/local-ollama-setup
- Fetched at: 2026-06-23T14:15:06Z
...
What You Need ​
Component Minimum Recommended RAM 8 GB (for 3B models) 32+ GB (for 27B+ models) Storage 5 GB free 30+ GB (for multiple models) CPU 4 cores 8+ cores (AMD EPYC, Ryzen, Intel Xeon) GPU Not required NVIDIA GPU with 8+ GB VRAM speeds things up significantly
...
Model Size on Disk RAM Needed Tool Calling Best For gemma4:31b ~20 GB 24+ GB Yes Best quality — strong tool use and reasoning gemma2:27b ~16 GB 20+ GB No Conversational tasks, no tool use gemma2:9b ~5 GB 8+ GB No Fast chat, Q&A — cannot call tools llama3.2:3b ~2 GB 4+ GB No Lightweight quick answers only
...
Task Recommended Model Why File edits, code, terminal commands gemma4:31b Only model with reliable tool calling Quick Q&A (no tool use needed) gemma2:9b Fast responses for conversational tasks Lightweight chat llama3.2:3b Fastest, but very limited capabilities
note
...
Provider Cost per Session Monthly (daily use) Anthropic Claude Sonnet ~$0.80 ~$24 OpenRouter (GPT-4o) ~$0.60 ~$18 Ollama (local) $0.00 $0.00
