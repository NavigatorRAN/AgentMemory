...
- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/use-voice-mode-with-hermes
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/use-voice-mode-with-hermes
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/use-voice-mode-with-hermes
- Fetched at: 2026-06-23T14:15:22Z
...
tip
Nous Portal bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
...
Mode Best for Platform Interactive microphone loop Personal hands-free use while coding or researching CLI Voice replies in chat Spoken responses alongside normal messaging Telegram, Discord Live voice channel bot Group or personal live conversation in a VC Discord voice channels
A good path is:
...
or
Modes ​
Mode Meaning off text only voice_only speak only when the user sent voice all speak every reply
