# Serving Llms Vllm — vLLM: high-throughput LLM serving, OpenAI API, quantization | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-inference-vllm
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-inference-vllm
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-inference-vllm
- Fetched at: 2026-06-23T14:18:25Z
...
vLLM: high-throughput LLM serving, OpenAI API, quantization.
Skill metadata ​
Source Bundled (installed by default) Path skills/mlops/inference/vllm Version 1.0.0 Author Orchestra Research License MIT Dependencies vllm , torch , transformers Platforms linux, macos Tags vLLM , Inference Serving , PagedAttention , Continuous Batching , High Throughput , Production , OpenAI API , Quantization , Tensor Parallelism
