# Polymarket — Query Polymarket: markets, prices, orderbooks, history | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-polymarket
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-polymarket
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-polymarket
- Fetched at: 2026-06-23T14:18:43Z
...
Query Polymarket: markets, prices, orderbooks, history.
Skill metadata ​
Source Bundled (installed by default) Path skills/research/polymarket Version 1.0.0 Author Hermes Agent + Teknium Platforms linux, macos, windows
