...
- Requested URL: https://docs.openclaw.ai/concepts/model-failover
- Final URL: https://docs.openclaw.ai/concepts/model-failover
- Canonical URL: https://docs.openclaw.ai/concepts/model-failover
- Fetched at: 2026-06-23T14:38:54Z
...
bash Copy code OPENCLAW_FALLBACK_SKIP_TTL_MS=60000
...
text Copy code ↪️ Model Fallback: <fallback> (selected <primary>; <reason>)
When a later probe succeeds and the session returns to the selected primary, OpenClaw sends:
text Copy code ↪️ Model Fallback cleared: <primary> (was <fallback>)
...
json Copy code { "usageStats" : { "provider:profile" : { "lastUsed" : 1736160000000 , "cooldownUntil" : 1736160600000 , "errorCount" : 2 } } }
Billing disables
...
json Copy code { "usageStats" : { "provider:profile" : { "disabledUntil" : 1736178000000 , "disabledReason" : "billing" } } }
Defaults:
