...
- Requested URL: https://docs.openclaw.ai/concepts/queue
- Final URL: https://docs.openclaw.ai/concepts/queue
- Canonical URL: https://docs.openclaw.ai/concepts/queue
- Fetched at: 2026-06-23T14:39:08Z
...
json5 Copy code { messages : { queue : { mode : "steer" , debounceMs : 500 , cap : 20 , drop : "summarize" , byChannel : { discord : "collect" }, }, }, }
Queue options
