# Dynamic Callback Management | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/dynamic_logging
- Final URL: https://docs.litellm.ai/docs/proxy/dynamic_logging
- Canonical URL: https://docs.litellm.ai/docs/proxy/dynamic_logging
- Fetched at: 2026-06-23T14:30:09Z
...
First, list your active callbacks to see what's currently enabled
Then, disable specific callbacks as needed for your requests
