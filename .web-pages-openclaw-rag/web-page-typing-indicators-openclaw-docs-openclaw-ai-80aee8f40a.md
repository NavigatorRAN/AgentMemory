...
- Requested URL: https://docs.openclaw.ai/concepts/typing-indicators
- Final URL: https://docs.openclaw.ai/concepts/typing-indicators
- Canonical URL: https://docs.openclaw.ai/concepts/typing-indicators
- Fetched at: 2026-06-23T14:39:21Z
...
json5 Copy code { agents : { defaults : { typingMode : "thinking" , typingIntervalSeconds : 6 , }, }, }
Override mode or cadence per session:
json5 Copy code { session : { typingMode : "message" , typingIntervalSeconds : 4 , }, }
Notes
