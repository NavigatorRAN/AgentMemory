# Hire Your First Agent | Paperclip Docs

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.paperclip.ing/guides/getting-started/your-first-agent
- Final URL: https://docs.paperclip.ing/guides/getting-started/your-first-agent/
- Canonical URL: https://docs.paperclip.ing/guides/getting-started/your-first-agent
- Fetched at: 2026-06-23T13:37:52Z
- Content type: text/html; charset=utf-8

## Description

An agent isn't just "an AI". It's a configuration — a specific role, with a specific AI system powering it, operating under a specific budget, with defined rules for when and how i
...
An API key from Anthropic (for the claude_local adapter) or OpenAI (for codex_local ) — see the Installation guide for how to get one
For claude_local : Claude Code installed on your Mac
...
Prerequisites: Claude Code must be installed on your Mac. If you haven't installed it, follow the Claude Code installation guide — it's a separate Anthropic product. Come back here once it's installed.
...
Prerequisites: You'll need the OpenAI Codex CLI installed. Check the OpenAI documentation for installation instructions.
...
Test the environment again if needed
