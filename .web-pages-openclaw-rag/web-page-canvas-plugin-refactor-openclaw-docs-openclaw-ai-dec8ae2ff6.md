# Canvas plugin refactor - OpenClaw

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.openclaw.ai/refactor/canvas
- Final URL: https://docs.openclaw.ai/refactor/canvas
- Canonical URL: https://docs.openclaw.ai/refactor/canvas
- Fetched at: 2026-06-23T14:56:15Z
...
Migration steps
Treat plugins.entries.canvas.config.host as the plugin-owned config surface.
Update docs so Canvas is described as an experimental bundled plugin.
