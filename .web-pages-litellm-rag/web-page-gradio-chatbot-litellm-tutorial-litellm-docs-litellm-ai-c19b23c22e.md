# Gradio Chatbot + LiteLLM Tutorial | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/tutorials/gradio_integration
- Final URL: https://docs.litellm.ai/docs/tutorials/gradio_integration
- Canonical URL: https://docs.litellm.ai/docs/tutorials/gradio_integration
- Fetched at: 2026-06-23T14:34:15Z
...
Launch Gradio App ​
From command line: python app.py or gradio app.py (latter enables live deployment updates)
Visit provided hyperlink in your browser.
Enjoy prompt-agnostic interaction with remote LLM server.
