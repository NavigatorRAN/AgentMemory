# Blogwatcher — Monitor blogs and RSS/Atom feeds via blogwatcher-cli tool | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-blogwatcher
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-blogwatcher
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/research/research-blogwatcher
- Fetched at: 2026-06-23T14:18:41Z
...
Monitor blogs and RSS/Atom feeds via blogwatcher-cli tool.
Skill metadata ​
Source Bundled (installed by default) Path skills/research/blogwatcher Version 2.0.0 Author JulienTant (fork of Hyaxia/blogwatcher) License MIT Platforms linux, macos, windows Tags RSS , Blogs , Feed-Reader , Monitoring
