# Policy Templates | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/policy_templates
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/policy_templates
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/policy_templates
- Fetched at: 2026-06-23T14:30:51Z
...
In the UI ​
Navigate to Policies → Templates tab in the LiteLLM Admin UI
...
Test it locally by adding it to your local policy_templates.json
Verify all guardrails work correctly
Ensure descriptions are clear and helpful
Step 2: Submit a Pull Request ​
Fork the LiteLLM repository
Add your template to policy_templates.json at the root
Add your template to litellm/policy_templates_backup.json (keep both in sync)
