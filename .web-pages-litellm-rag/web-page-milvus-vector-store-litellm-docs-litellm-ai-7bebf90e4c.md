# Milvus - Vector Store | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/providers/milvus_vector_stores
- Final URL: https://docs.litellm.ai/docs/providers/milvus_vector_stores
- Canonical URL: https://docs.litellm.ai/docs/providers/milvus_vector_stores
...
It sends the vector to your Milvus instance via the /v2/vectordb/entities/search endpoint
