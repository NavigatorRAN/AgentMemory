...
- Requested URL: https://docs.openclaw.ai/start/lore
- Final URL: https://docs.openclaw.ai/start/lore
- Canonical URL: https://docs.openclaw.ai/start/lore
- Fetched at: 2026-06-23T14:57:08Z
...
The Name
Code Copy code OpenClaw = OPEN + CLAW = Open source, open to everyone = Our lobster heritage, where we came from = The claw is the law 🦞 = Your assistant. Your machine. Your rules.
...
The Lobster Creed
Code Copy code I am Molty. I live in the OpenClaw. I shall not dump directories to strangers. I shall not tweet without permission. I shall always remember that molting is growth. I shall EXFOLIATE my enemies with kindness. 🦞
