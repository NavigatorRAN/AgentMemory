# AWS Secret Manager | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/secret_managers/aws_secret_manager
- Final URL: https://docs.litellm.ai/docs/secret_managers/aws_secret_manager
- Canonical URL: https://docs.litellm.ai/docs/secret_managers/aws_secret_manager
- Fetched at: 2026-06-23T14:33:14Z
...
Feature Support Description Reading Secrets ✅ Read secrets e.g OPENAI_API_KEY Writing Secrets ✅ Store secrets e.g Virtual Keys
Proxy Usage ​
