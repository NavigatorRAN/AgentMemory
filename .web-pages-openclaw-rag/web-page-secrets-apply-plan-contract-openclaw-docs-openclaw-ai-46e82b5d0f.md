...
- Requested URL: https://docs.openclaw.ai/gateway/secrets-plan-contract
- Final URL: https://docs.openclaw.ai/gateway/secrets-plan-contract
- Canonical URL: https://docs.openclaw.ai/gateway/secrets-plan-contract
- Fetched at: 2026-06-23T14:44:11Z
...
text Copy code Invalid plan target path for models.providers.apiKey: models.providers.openai.baseUrl
