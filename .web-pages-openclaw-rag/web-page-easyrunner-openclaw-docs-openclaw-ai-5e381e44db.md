...
- Requested URL: https://docs.openclaw.ai/platforms/easyrunner
- Final URL: https://docs.openclaw.ai/platforms/easyrunner
- Canonical URL: https://docs.openclaw.ai/platforms/easyrunner
- Fetched at: 2026-06-23T14:49:24Z
...
json5 Copy code { gateway : { bind : "lan" , port : 1455 , auth : { token : "${OPENCLAW_GATEWAY_TOKEN}" , }, }, }
...
bash Copy code openclaw gateway probe --url https://openclaw.example.com --token <token> openclaw gateway status --url https://openclaw.example.com --token <token>
