...
- Requested URL: https://docs.openclaw.ai/gateway/health
- Final URL: https://docs.openclaw.ai/gateway/health
- Canonical URL: https://docs.openclaw.ai/gateway/health
- Fetched at: 2026-06-23T14:43:47Z
...
For bug reports, run openclaw gateway diagnostics export and attach the generated zip. The export combines a Markdown summary, the newest stability bundle, sanitized log metadata, sanitized Gateway status/health snapshots, and config shape. It is meant to be shared: chat text, webhook bodies, tool outputs, credentials, cookies, account/message identifiers, and secret values are omitted or redacted. See Diagnostics Export .
