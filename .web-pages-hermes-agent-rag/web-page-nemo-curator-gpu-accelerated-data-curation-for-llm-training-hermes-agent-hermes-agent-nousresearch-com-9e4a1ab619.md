...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-nemo-curator
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-nemo-curator
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-nemo-curator
- Fetched at: 2026-06-23T14:20:03Z
...
Skill metadata ​
Source Optional — install with hermes skills install official/mlops/nemo-curator Path optional-skills/mlops/nemo-curator Version 1.0.0 Author Orchestra Research License MIT Dependencies nemo-curator , cudf , dask , rapids Platforms linux, macos Tags Data Processing , NeMo Curator , Data Curation , GPU Acceleration , Deduplication , Quality Filtering , NVIDIA , RAPIDS , PII Redaction , Multimodal , LLM Training Data
