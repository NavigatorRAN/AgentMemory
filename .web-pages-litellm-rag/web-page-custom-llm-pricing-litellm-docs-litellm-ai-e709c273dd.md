...
- Requested URL: https://docs.litellm.ai/docs/proxy/custom_pricing
- Final URL: https://docs.litellm.ai/docs/proxy/custom_pricing
- Canonical URL: https://docs.litellm.ai/docs/proxy/custom_pricing
- Fetched at: 2026-06-23T14:29:56Z
...
Provider Margins - Add fees/margins to LLM costs for internal billing
...
Vertex AI Gemini : Uses usageMetadata.trafficType ( ON_DEMAND_PRIORITY → priority, FLEX / BATCH → flex). See Vertex AI - PayGo / Priority Cost Tracking .
Bedrock : Uses serviceTier from the response. See Bedrock - Usage - Service Tier .
