# Wireguard - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/guides/vpn/wireguard
- Final URL: https://docs.pi-hole.net/guides/vpn/wireguard/
- Canonical URL: https://docs.pi-hole.net/guides/vpn/wireguard/
- Fetched at: 2026-06-23T13:43:09Z
