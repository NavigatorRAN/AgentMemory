...
- Requested URL: https://docs.litellm.ai/docs/providers/gmi
- Final URL: https://docs.litellm.ai/docs/providers/gmi
- Canonical URL: https://docs.litellm.ai/docs/providers/gmi
- Fetched at: 2026-06-23T14:27:56Z
...
Copy as Markdown
Overview ​
Property Details Description GMI Cloud is a GPU cloud infrastructure provider offering access to top AI models including Claude, GPT, DeepSeek, Gemini, and more through OpenAI-compatible APIs. Provider Route on LiteLLM gmi/ Link to Provider Doc GMI Cloud Docs ↗ Base URL https://api.gmi-serving.com/v1 Supported Operations /chat/completions , /models
What is GMI Cloud? ​
