...
- Requested URL: https://docs.openclaw.ai/concepts/markdown-formatting
- Final URL: https://docs.openclaw.ai/concepts/markdown-formatting
- Canonical URL: https://docs.openclaw.ai/concepts/markdown-formatting
- Fetched at: 2026-06-23T14:38:45Z
...
IR example
Input Markdown:
markdown Copy code Hello **world** - see [ docs ]( https://docs.openclaw.ai ).
IR (schematic):
json Copy code { "text" : "Hello world - see docs." , "styles" : [ { "start" : 6 , "end" : 11 , "style" : "bold" } ] , "links" : [ { "start" : 19 , "end" : 23 , "href" : "https://docs.openclaw.ai" } ] }
Where it is used
...
Config keys:
yaml Copy code channels: discord: markdown: tables: code accounts: work: markdown: tables: off
Chunking rules
