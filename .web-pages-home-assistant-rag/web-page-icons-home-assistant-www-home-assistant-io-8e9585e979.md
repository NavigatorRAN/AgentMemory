...
- Requested URL: https://www.home-assistant.io/docs/frontend/icons
- Final URL: https://www.home-assistant.io/docs/frontend/icons
- Canonical URL: https://www.home-assistant.io/docs/frontend/icons/
- Fetched at: 2026-06-28T02:22:10Z
- Content type: text/html; charset=UTF-8

## Description

Material Design Icons in the Home Assistant frontend
...
Before suggesting or creating a new icon, it is very important that you search the current library and search all issues , open and closed, on their GitHub. Try searching with different terms that might mean the same thing. For example: “user”, “person”, or “account”.
