# Dogfood — Exploratory QA of web apps: find bugs, evidence, reports | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/dogfood/dogfood-dogfood
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/dogfood/dogfood-dogfood
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/dogfood/dogfood-dogfood
- Fetched at: 2026-06-23T14:18:06Z
...
Exploratory QA of web apps: find bugs, evidence, reports.
Skill metadata ​
Source Bundled (installed by default) Path skills/dogfood Version 1.0.0 Platforms linux, macos, windows Tags qa , testing , browser , web , dogfood
