# Onyx Security | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/onyx_security
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/onyx_security
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/onyx_security
...
Go to Onyx's platform and create a new AI Guard policy.
