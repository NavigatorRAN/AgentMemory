...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-modal
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-modal
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-modal
- Fetched at: 2026-06-23T14:20:02Z
- Content type: text/html; charset=utf-8

## Description

Serverless GPU cloud platform for running ML workloads
...
Skill metadata ​
Source Optional — install with hermes skills install official/mlops/modal Path optional-skills/mlops/modal Version 1.0.0 Author Orchestra Research License MIT Dependencies modal>=0.64.0 Platforms linux, macos, windows Tags Infrastructure , Serverless , GPU , Cloud , Deployment , Modal
