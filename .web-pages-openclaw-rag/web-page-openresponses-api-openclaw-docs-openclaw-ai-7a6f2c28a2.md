...
- Requested URL: https://docs.openclaw.ai/gateway/openresponses-http-api
- Final URL: https://docs.openclaw.ai/gateway/openresponses-http-api
- Canonical URL: https://docs.openclaw.ai/gateway/openresponses-http-api
- Fetched at: 2026-06-23T14:43:56Z
...
json Copy code { "type" : "function_call_output" , "call_id" : "call_123" , "output" : "{\"temperature\": \"72F\"}" }
...
json Copy code { "type" : "input_image" , "source" : { "type" : "url" , "url" : "https://example.com/image.png" } }
Allowed MIME types (current): image/jpeg , image/png , image/gif , image/webp , image/heic , image/heif .
Max size (current): 10MB.
Files ( input_file )
json Copy code { "type" : "input_file" , "source" : { "type" : "base64" , "media_type" : "text/plain" , "data" : "SGVsbG8gV29ybGQh" , "filename" : "hello.txt" } }
...
json Copy code { "error" : { "message" : "..." , "type" : "invalid_request_error" } }
Common cases:
...
Examples
Non-streaming:
bash Copy code curl -sS http://127.0.0.1:18789/v1/responses \ -H 'Authorization: Bearer YOUR_TOKEN' \ -H 'Content-Type: application/json' \ -H 'x-openclaw-agent-id: main' \ -d '{ "model" : "openclaw" , "input" : "hi" } '
Streaming:
bash Copy code curl -N http://127.0.0.1:18789/v1/responses \ -H 'Authorization: Bearer YOUR_TOKEN' \ -H 'Content-Type: application/json' \ -H 'x-openclaw-agent-id: main' \ -d '{ "model" : "openclaw" , "stream" : true , "input" : "hi" } '
Related
