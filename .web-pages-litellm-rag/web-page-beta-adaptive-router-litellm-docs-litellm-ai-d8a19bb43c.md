# [BETA] Adaptive Router | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/adaptive_router
- Final URL: https://docs.litellm.ai/docs/adaptive_router
- Canonical URL: https://docs.litellm.ai/docs/adaptive_router
- Fetched at: 2026-06-23T14:22:34Z
...
Goal quality cost Minimize cost, quality is secondary 0.3 0.7 Balanced 0.5 0.5 Quality-first (default) 0.7 0.3 Quality non-negotiable 0.9 0.1
