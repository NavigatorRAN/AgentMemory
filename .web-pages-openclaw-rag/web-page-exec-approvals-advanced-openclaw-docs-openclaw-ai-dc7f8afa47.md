# Exec approvals — advanced - OpenClaw

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.openclaw.ai/tools/exec-approvals-advanced
- Final URL: https://docs.openclaw.ai/tools/exec-approvals-advanced
- Canonical URL: https://docs.openclaw.ai/tools/exec-approvals-advanced
- Fetched at: 2026-06-23T14:57:47Z
...
json5 Copy code { tools : { exec : { safeBins : [ "jq" , "myfilter" ], safeBinProfiles : { myfilter : { minPositional : 0 , maxPositional : 0 , allowedValueFlags : [ "-n" , "--limit" ], deniedFlags : [ "-f" , "--file" , "-c" , "--command" ], }, }, }, }, }
...
Config:
json5 Copy code { approvals : { exec : { enabled : true , mode : "session" , // "session" | "targets" | "both" agentFilter : [ "main" ], sessionFilter : [ "discord" ], // substring or regex targets : [ { channel : "slack" , to : "U12345678" }, { channel : "telegram" , to : "123456789" }, ], }, }, }
Reply in chat:
Code Copy code /approve <id> allow-once /approve <id> allow-always /approve <id> deny
...
json5 Copy code { approvals : { plugin : { enabled : true , mode : "targets" , agentFilter : [ "main" ], targets : [ { channel : "slack" , to : "U12345678" }, { channel : "telegram" , to : "123456789" }, ], }, }, }
...
Telegram
macOS IPC flow
Code Copy code Gateway -> Node Service (WS) | IPC (UDS + token + HMAC + TTL) v Mac App (UI + approvals + system.run)
Security notes:
...
json5 Copy code { approvals : { exec : { enabled : true , mode : "targets" , targets : [ { channel : "telegram" , to : "-1001234567890" , accountId : "ops-bot" , threadId : "77" , }, ], }, }, channels : { telegram : { accounts : { default : { name : "Primary bot" , botToken : "env:TELEGRAM_PRIMARY_BOT_TOKEN" , }, "ops-bot" : { name : "Operations bot" , botToken : "env:TELEGRAM_OPS_BOT_TOKEN" , }, }, }, }, }
