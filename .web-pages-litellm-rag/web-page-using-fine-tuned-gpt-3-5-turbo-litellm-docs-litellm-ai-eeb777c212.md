# Using Fine-Tuned gpt-3.5-turbo | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/tutorials/finetuned_chat_gpt
- Final URL: https://docs.litellm.ai/docs/tutorials/finetuned_chat_gpt
- Canonical URL: https://docs.litellm.ai/docs/tutorials/finetuned_chat_gpt
- Fetched at: 2026-06-23T14:34:07Z
