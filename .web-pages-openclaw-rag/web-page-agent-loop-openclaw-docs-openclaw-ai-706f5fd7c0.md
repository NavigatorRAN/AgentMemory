...
- Requested URL: https://docs.openclaw.ai/concepts/agent-loop
- Final URL: https://docs.openclaw.ai/concepts/agent-loop
- Canonical URL: https://docs.openclaw.ai/concepts/agent-loop
- Fetched at: 2026-06-23T14:38:26Z
...
subscribeEmbeddedAgentSession bridges agent runtime events to OpenClaw agent stream:
