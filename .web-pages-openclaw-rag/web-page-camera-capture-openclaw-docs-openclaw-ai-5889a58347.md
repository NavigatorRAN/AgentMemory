...
- Requested URL: https://docs.openclaw.ai/nodes/camera
- Final URL: https://docs.openclaw.ai/nodes/camera
- Canonical URL: https://docs.openclaw.ai/nodes/camera
- Fetched at: 2026-06-23T14:49:07Z
...
Examples:
bash Copy code openclaw nodes camera snap --node < id > # default: both front + back (2 MEDIA lines) openclaw nodes camera snap --node < id > --facing front openclaw nodes camera clip --node < id > --duration 3000 openclaw nodes camera clip --node < id > --no-audio
Notes:
...
bash Copy code openclaw nodes screen record --node < id > --duration 10s --fps 15 # prints saved path
