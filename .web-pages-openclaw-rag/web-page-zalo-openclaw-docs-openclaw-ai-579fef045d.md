...
- Requested URL: https://docs.openclaw.ai/channels/zalo
- Final URL: https://docs.openclaw.ai/channels/zalo
- Canonical URL: https://docs.openclaw.ai/channels/zalo
- Fetched at: 2026-06-23T14:36:46Z
...
Ensure the Zalo plugin is available.
...
Minimal config:
json5 Copy code { channels : { zalo : { enabled : true , accounts : { default : { botToken : "12345689:abc-xyz" , dmPolicy : "pairing" , }, }, }, }, }
What it is
...
Copy the full bot token (typically numeric_id:secret ). For Marketplace bots, the usable runtime token may appear in the bot's welcome message after creation.
