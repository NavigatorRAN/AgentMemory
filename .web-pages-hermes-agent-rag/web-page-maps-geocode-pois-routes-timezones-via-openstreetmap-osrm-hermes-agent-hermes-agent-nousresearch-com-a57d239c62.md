...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-maps
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-maps
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/productivity/productivity-maps
- Fetched at: 2026-06-23T14:18:32Z
...
Geocode, POIs, routes, timezones via OpenStreetMap/OSRM.
Skill metadata ​
Source Bundled (installed by default) Path skills/productivity/maps Version 1.2.0 Author Mibayy License MIT Platforms linux, macos, windows Tags maps , geocoding , places , routing , distance , directions , nearby , location , openstreetmap , nominatim , overpass , osrm
