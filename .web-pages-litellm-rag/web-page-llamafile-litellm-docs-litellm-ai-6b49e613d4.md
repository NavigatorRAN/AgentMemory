...
- Requested URL: https://docs.litellm.ai/docs/providers/llamafile
- Final URL: https://docs.litellm.ai/docs/providers/llamafile
- Canonical URL: https://docs.litellm.ai/docs/providers/llamafile
- Fetched at: 2026-06-23T14:28:13Z
...
Copy as Markdown
LiteLLM supports all models on Llamafile.
Property Details Description llamafile lets you distribute and run LLMs with a single file. Docs Provider Route on LiteLLM llamafile/ (for OpenAI compatible server) Provider Doc llamafile ↗ Supported Endpoints /chat/completions , /embeddings , /completions
Quick Start
