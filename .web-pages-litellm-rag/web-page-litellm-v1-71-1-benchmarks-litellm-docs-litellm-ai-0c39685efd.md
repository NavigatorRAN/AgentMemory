# LiteLLM v1.71.1 Benchmarks | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/aiohttp_benchmarks
- Final URL: https://docs.litellm.ai/docs/aiohttp_benchmarks
- Canonical URL: https://docs.litellm.ai/docs/aiohttp_benchmarks
- Fetched at: 2026-06-23T14:22:44Z
...
Benchmark Results ​
Metric httpx (Existing) aiohttp (LiteLLM v1.71.1) Improvement Calculation RPS 50.2 224 +346% ✅ (224 - 50.2) / 50.2 × 100 = 346% Median Latency 2,500ms 74ms -97% ✅ (74 - 2500) / 2500 × 100 = -97% 95th Percentile 5,600ms 250ms -96% ✅ (250 - 5600) / 5600 × 100 = -96% 99th Percentile 6,200ms 330ms -95% ✅ (330 - 6200) / 6200 × 100 = -95%
Key Improvements ​
