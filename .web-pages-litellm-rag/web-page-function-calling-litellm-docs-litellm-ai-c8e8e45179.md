# Function Calling | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/completion/function_call
- Final URL: https://docs.litellm.ai/docs/completion/function_call
- Canonical URL: https://docs.litellm.ai/docs/completion/function_call
- Fetched at: 2026-06-23T14:23:09Z
...
Define your function get_current_weather
Add a docstring to your function get_current_weather
Pass the function to litellm.utils.function_to_dict to get the dictionary for OpenAI function calling
