# Darwinian Evolver — Evolve prompts/regex/SQL/code with Imbue's evolution loop | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-darwinian-evolver
- Fetched at: 2026-06-23T14:20:37Z
...
Evolve prompts/regex/SQL/code with Imbue's evolution loop.
Skill metadata ​
Source Optional — install with hermes skills install official/research/darwinian-evolver Path optional-skills/research/darwinian-evolver Version 0.1.0 Author Bihruze (Asahi0x), Hermes Agent License MIT Platforms linux, macos Tags evolution , optimization , prompt-engineering , research Related skills arxiv , jupyter-live-kernel
Reference: full SKILL.md ​
info
The following is the complete skill definition that Hermes loads when this skill is triggered. This is what the agent sees as instructions when the skill is active.
Darwinian Evolver
Run Imbue's darwinian_evolver — an
...
Mutator — .mutate(organism, failure_cases, learning_log_entries) -> list[Organism] .
...
Provider content filters kill runs. Azure-backed OpenRouter models
...
loop.run() is a generator — calling it doesn't run anything until
you iterate. Use for snap in loop.run(num_iterations=N): .
Snapshots are nested pickles. iteration_N.pkl contains a dict with
...
Concurrency defaults are aggressive. 10/10 will hit rate limits on
most providers. Start with 2/2.
CLI is hardcoded to Anthropic. uv run darwinian_evolver <problem>
reaches for ANTHROPIC_API_KEY and uses Claude Sonnet. To use any other
provider, write a driver like parrot_openrouter.py .
AGPL. Never from darwinian_evolver import ... inside Hermes core.
Custom driver scripts under ~/.hermes/skills/... are user-side and fine.
No PyPI package. pip install darwinian-evolver will pull the wrong
...
Imbue research post
ARC-AGI-2 results
imbue-ai/darwinian_evolver (AGPL-3.0)
