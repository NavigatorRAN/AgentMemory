...
- Requested URL: https://docs.litellm.ai/docs/proxy/ui_logs
- Final URL: https://docs.litellm.ai/docs/proxy/ui_logs
- Canonical URL: https://docs.litellm.ai/docs/proxy/ui_logs
- Fetched at: 2026-06-23T14:32:23Z
...
View Spend, Token Usage, Key, Team Name for Each Request to LiteLLM
Overview ​
Log Type Tracked by Default Success Logs ✅ Yes Error Logs ✅ Yes Request/Response Content Stored ❌ No by Default, opt in with store_prompts_in_spend_logs
