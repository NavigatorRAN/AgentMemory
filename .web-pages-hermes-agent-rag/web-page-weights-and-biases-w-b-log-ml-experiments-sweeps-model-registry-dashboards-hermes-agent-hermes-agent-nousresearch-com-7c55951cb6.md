# Weights And Biases — W&B: log ML experiments, sweeps, model registry, dashboards | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-evaluation-weights-and-biases
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-evaluation-weights-and-biases
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/mlops/mlops-evaluation-weights-and-biases
- Fetched at: 2026-06-23T14:18:21Z
...
W&B: log ML experiments, sweeps, model registry, dashboards.
Skill metadata ​
Source Bundled (installed by default) Path skills/mlops/evaluation/weights-and-biases Version 1.0.0 Author Orchestra Research License MIT Dependencies wandb Platforms linux, macos, windows Tags MLOps , Weights And Biases , WandB , Experiment Tracking , Hyperparameter Tuning , Model Registry , Collaboration , Real-Time Visualization , PyTorch , TensorFlow , HuggingFace
