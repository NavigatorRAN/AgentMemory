# Python Debugpy — Debug Python: pdb REPL + debugpy remote (DAP) | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-python-debugpy
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-python-debugpy
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/software-development/software-development-python-debugpy
- Fetched at: 2026-06-23T14:18:52Z
...
Debug Python: pdb REPL + debugpy remote (DAP).
Skill metadata ​
Source Bundled (installed by default) Path skills/software-development/python-debugpy Version 1.0.0 Author Hermes Agent License MIT Platforms linux, macos Tags debugging , python , pdb , debugpy , breakpoints , dap , post-mortem Related skills systematic-debugging , node-inspect-debugger , debugging-hermes-tui-commands
