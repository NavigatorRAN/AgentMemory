...
- Requested URL: https://docs.openclaw.ai/channels/irc
- Final URL: https://docs.openclaw.ai/channels/irc
- Canonical URL: https://docs.openclaw.ai/channels/irc
- Fetched at: 2026-06-23T14:36:11Z
- Content type: text/html; charset=utf-8

## Description

IRC plugin setup, access controls, and troubleshooting
...
Quick start
Install the plugin:
bash Copy code openclaw plugins install @openclaw/irc
Enable IRC config in ~/.openclaw/openclaw.json .
Set at least:
json5 Copy code { channels : { irc : { enabled : true , host : "irc.example.com" , port : 6697 , tls : true , nick : "openclaw-bot" , channels : [ "#openclaw" ], }, }, }
...
json5 Copy code { channels : { irc : { groupPolicy : "allowlist" , groups : { "#tuirc-dev" : { allowFrom : [ "*" ] }, }, }, }, }
...
json5 Copy code { channels : { irc : { groupPolicy : "allowlist" , groups : { "#tuirc-dev" : { requireMention : false , allowFrom : [ "*" ], }, }, }, }, }
Or to allow all IRC channels (no per-channel allowlist) and still reply without mentions:
json5 Copy code { channels : { irc : { groupPolicy : "open" , groups : { "*" : { requireMention : false , allowFrom : [ "*" ] }, }, }, }, }
...
json5 Copy code { channels : { irc : { groups : { "#tuirc-dev" : { allowFrom : [ "*" ], tools : { deny : [ "group:runtime" , "group:fs" , "gateway" , "nodes" , "cron" , "browser" ], }, }, }, }, }, }
Different tools per sender (owner gets more power)
Use toolsBySender to apply a stricter policy to "*" and a looser one to your nick:
json5 Copy code { channels : { irc : { groups : { "#tuirc-dev" : { allowFrom : [ "*" ], toolsBySender : { "*" : { deny : [ "group:runtime" , "group:fs" , "gateway" , "nodes" , "cron" , "browser" ], }, "id:eigen" : { deny : [ "gateway" , "nodes" , "cron" ], }, }, }, }, }, }, }
Notes:
...
json5 Copy code { channels : { irc : { nickserv : { enabled : true , service : "NickServ" , password : "your-nickserv-password" , }, }, }, }
Optional one-time registration on connect:
json5 Copy code { channels : { irc : { nickserv : { register : true , registerEmail : "bot@example.com" , }, }, }, }
