# Bedrock Guardrails | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/guardrails/bedrock
- Final URL: https://docs.litellm.ai/docs/proxy/guardrails/bedrock
- Canonical URL: https://docs.litellm.ai/docs/proxy/guardrails/bedrock
- Fetched at: 2026-06-23T14:30:21Z
...
Set mode to pre_call to run the guardrail check before the LLM call
Enable masking by setting mask_request_content and/or mask_response_content to true
