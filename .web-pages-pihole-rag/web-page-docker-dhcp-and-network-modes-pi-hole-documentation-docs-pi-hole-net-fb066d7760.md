...
- Requested URL: https://docs.pi-hole.net/docker/DHCP
- Final URL: https://docs.pi-hole.net/docker/dhcp/
- Canonical URL: https://docs.pi-hole.net/docker/DHCP/
- Fetched at: 2026-06-23T13:41:34Z
- Content type: text/html; charset=UTF-8

## Description

Setting up DHCP for Docker Pi-hole
