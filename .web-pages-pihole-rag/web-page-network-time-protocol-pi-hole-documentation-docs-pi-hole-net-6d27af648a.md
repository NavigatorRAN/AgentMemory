# Network Time Protocol - Pi-hole documentation

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.pi-hole.net/guides/misc/ntp
- Final URL: https://docs.pi-hole.net/guides/misc/ntp/
- Canonical URL: https://docs.pi-hole.net/guides/misc/ntp/
- Fetched at: 2026-06-23T13:42:36Z
...
The default server is pool.ntp.org , which selects a server from the NTP pool project , a virtual cluster of timeservers providing reliable, easy to use NTP service. The NTP Pool is generally of very high quality, but it is a service run by volunteers in their spare time.
Other public ntp servers include
time.cloudflare.com , time.facebook.com and time.google.com
