...
- Requested URL: https://docs.litellm.ai/docs/observability/newrelic
- Final URL: https://docs.litellm.ai/docs/observability/newrelic
- Canonical URL: https://docs.litellm.ai/docs/observability/newrelic
- Fetched at: 2026-06-23T14:25:22Z
...
Copy as Markdown
Prerequisite ​
In order to use LiteLLM with New Relic, you will need to have a New Relic account and license key . If you do not have a New Relic account yet, you can create a free tier account .
This page covers using New Relic with LiteLLM in proxy mode. You can also use New Relic with the LiteLLM SDK by including the New Relic Python Agent in your application. Please refer to the New Relic AI Monitoring documentation .
Configuration ​
...
LiteLLM admin UI documentation to access the admin UI and include the New Relic callback within the Settings section.
Required environment variables ​
The New Relic Python Agent requires configuration to report telemetry to New Relic. The New Relic Python Agent supports defining configuration via both a configuration file and environment variables. With LiteLLM, it is recommended to use environment variables, but both options will work.
...
The New Relic Python Agent is used within applications to report Application Performance Monitoring (APM) telemetry to New Relic. By following the steps below, a New Relic customer will receive both the APM telemetry for LiteLLM as well as the LLM messages within AI Monitoring from their LiteLLM server.
...
The New Relic Python Agent has a number of ways to accept configuration. As shown above, environment variables can be used to set various optional configuration within the agent.
...
Support ​
For support with this integration, contact New Relic support .
Prerequisite
Configuration
Enable New Relic LiteLLM callback
Required environment variables
