...
- Requested URL: https://www.home-assistant.io/docs/locked_out
- Final URL: https://www.home-assistant.io/docs/locked_out
- Canonical URL: https://www.home-assistant.io/docs/locked_out/
- Fetched at: 2026-06-28T02:22:14Z
- Content type: text/html; charset=UTF-8

## Description

Options for regaining access to your Home Assistant when you are locked out, including resetting the owner password and recovering your data.
...
In the terminal, enter the auth list command.
...
Listing all usernames via command line
Reset the Yellow
Reset the Green
