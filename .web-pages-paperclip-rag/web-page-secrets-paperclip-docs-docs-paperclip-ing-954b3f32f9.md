...
- Requested URL: https://docs.paperclip.ing/reference/api/secrets
- Final URL: https://docs.paperclip.ing/reference/api/secrets/
- Canonical URL: https://docs.paperclip.ing/reference/api/secrets
- Fetched at: 2026-06-23T13:39:20Z
...
Body:
Field Required Notes name Yes Unique within the company. value Yes The plaintext secret value to store. provider No Defaults to local_encrypted . description No Human-readable note for operators. externalRef No Required by some external providers.
...
Field Required Notes name No Rename the secret. Must still be unique within the company. description No Update the operator-facing note. externalRef No Update the provider reference without creating a new secret version.
...
Field Required Notes value Yes The new plaintext secret value. externalRef No If omitted, Paperclip keeps the existing external reference for the secret.
...
See Routine env map for the routine-side example.
Practical Notes
