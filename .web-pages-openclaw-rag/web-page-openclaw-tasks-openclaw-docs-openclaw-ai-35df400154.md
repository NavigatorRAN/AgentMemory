...
- Requested URL: https://docs.openclaw.ai/cli/tasks
- Final URL: https://docs.openclaw.ai/cli/tasks
- Canonical URL: https://docs.openclaw.ai/cli/tasks
- Fetched at: 2026-06-23T14:38:13Z
...
Usage
bash Copy code openclaw tasks openclaw tasks list openclaw tasks list --runtime acp openclaw tasks list --status running openclaw tasks show <lookup> openclaw tasks notify <lookup> state_changes openclaw tasks cancel <lookup> openclaw tasks audit openclaw tasks maintenance openclaw tasks maintenance --apply openclaw tasks flow list openclaw tasks flow show <lookup> openclaw tasks flow cancel <lookup>
Root Options
--json : output JSON.
...
Subcommands
list
bash Copy code openclaw tasks list [--runtime <name>] [--status <name>] [--json]
Lists tracked background tasks newest first.
show
bash Copy code openclaw tasks show <lookup> [--json]
Shows one task by task ID, run ID, or session key.
notify
bash Copy code openclaw tasks notify <lookup> <done_only|state_changes|silent>
Changes the notification policy for a running task.
cancel
bash Copy code openclaw tasks cancel <lookup>
Cancels a running background task.
audit
bash Copy code openclaw tasks audit [--severity <warn|error>] [--code <name>] [-- limit <n>] [--json]
...
maintenance
bash Copy code openclaw tasks maintenance [--apply] [--json]
...
flow
bash Copy code openclaw tasks flow list [--status <name>] [--json] openclaw tasks flow show <lookup> [--json] openclaw tasks flow cancel <lookup>
