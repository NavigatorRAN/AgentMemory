...
- Requested URL: https://docs.openclaw.ai/tools/ollama-search
- Final URL: https://docs.openclaw.ai/tools/ollama-search
- Canonical URL: https://docs.openclaw.ai/tools/ollama-search
- Fetched at: 2026-06-23T14:58:04Z
...
json5 Copy code { plugins : { entries : { ollama : { config : { webSearch : { baseUrl : "http://ollama-host:11434" , }, }, }, }, }, }
If you already configure Ollama as a model provider, the web-search provider can
reuse that host instead:
json5 Copy code { models : { providers : { ollama : { baseUrl : "http://ollama-host:11434" , }, }, }, }
...
json5 Copy code { models : { providers : { ollama : { baseUrl : "https://ollama.com" , apiKey : "OLLAMA_API_KEY" , }, }, }, tools : { web : { search : { provider : "ollama" , }, }, }, }
Notes
