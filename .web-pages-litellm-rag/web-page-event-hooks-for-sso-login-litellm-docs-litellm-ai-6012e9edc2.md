# ✨ Event Hooks for SSO Login | liteLLM

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.litellm.ai/docs/proxy/custom_sso
- Final URL: https://docs.litellm.ai/docs/proxy/custom_sso
- Canonical URL: https://docs.litellm.ai/docs/proxy/custom_sso
- Fetched at: 2026-06-23T14:29:59Z
- Content type: text/html; charset=utf-8

## Description

✨ SSO is free for up to 5 users. After that, an enterprise license is required. Get Started with Enterprise here
