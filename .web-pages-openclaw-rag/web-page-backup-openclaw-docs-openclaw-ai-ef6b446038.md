...
- Requested URL: https://docs.openclaw.ai/cli/backup
- Final URL: https://docs.openclaw.ai/cli/backup
- Canonical URL: https://docs.openclaw.ai/cli/backup
- Fetched at: 2026-06-23T14:37:17Z
...
bash Copy code openclaw backup create openclaw backup create --output ~/Backups openclaw backup create --dry-run --json openclaw backup create --verify openclaw backup create --no-include-workspace openclaw backup create --only-config openclaw backup verify ./2026-03-09T08-00-00.000+08-00-openclaw-backup.tar.gz
Notes
...
bash Copy code openclaw backup create --no-include-workspace
