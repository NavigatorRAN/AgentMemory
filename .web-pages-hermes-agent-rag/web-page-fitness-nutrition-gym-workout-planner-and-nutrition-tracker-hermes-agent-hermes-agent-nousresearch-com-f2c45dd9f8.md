# Fitness Nutrition — Gym workout planner and nutrition tracker | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/health/health-fitness-nutrition
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/health/health-fitness-nutrition
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/health/health-fitness-nutrition
- Fetched at: 2026-06-23T14:19:42Z
- Content type: text/html; charset=utf-8

## Description

Gym workout planner and nutrition tracker
...
Skill metadata ​
Source Optional — install with hermes skills install official/health/fitness-nutrition Path optional-skills/health/fitness-nutrition Version 1.0.0 License MIT Platforms linux, macos, windows Tags health , fitness , nutrition , gym , workout , diet , exercise
