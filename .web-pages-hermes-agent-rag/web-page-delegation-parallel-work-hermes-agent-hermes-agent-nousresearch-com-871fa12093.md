...
- Requested URL: https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns
- Final URL: https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns
- Canonical URL: https://hermes-agent.nousresearch.com/docs/guides/delegation-patterns
- Fetched at: 2026-06-23T14:15:01Z
...
Task type Toolsets Why Web research ["web"] web_search + web_extract only Code work ["terminal", "file"] Shell access + file operations Full-stack ["terminal", "file", "web"] Everything except messaging Read-only analysis ["file"] Can only read files, no shell
...
Config Default Range Effect max_concurrent_children 3 >=1 Parallel batch size per delegate_task call max_spawn_depth 1 >=1 How many delegation levels can spawn further
