...
- Requested URL: https://docs.openclaw.ai/cli/crestodian
- Final URL: https://docs.openclaw.ai/cli/crestodian
- Canonical URL: https://docs.openclaw.ai/cli/crestodian
- Fetched at: 2026-06-23T14:37:28Z
...
text Copy code ~/.openclaw/audit/crestodian.jsonl
...
text Copy code setup setup workspace ~/Projects/work setup workspace ~/Projects/work model openai/gpt-5.5
...
text Copy code talk to agent talk to work agent switch to main agent
...
text Copy code /crestodian /crestodian restart gateway
...
/crestodian <request>
Operator flow:
text Copy code You, in a trusted owner DM: /crestodian status OpenClaw: Crestodian rescue mode. Gateway reachable: no. Config valid: no. You: /crestodian restart gateway OpenClaw: Plan: restart the Gateway. Reply /crestodian yes to apply. You: /crestodian yes OpenClaw: Applied. Audit entry written.
Agent creation can also be queued from the local prompt or rescue mode:
text Copy code create agent work workspace ~/Projects/work model openai/gpt-5.5 /crestodian create agent work workspace ~/Projects/work
...
normal agent loop.
Config shape:
jsonc Copy code { "crestodian" : { "rescue" : { "enabled" : "auto" , "ownerDmOnly" : true , } , } , }
...
bash Copy code pnpm test :docker:crestodian-rescue
Configless local planner fallback is covered by:
bash Copy code pnpm test :docker:crestodian-planner
...
bash Copy code pnpm test :live:crestodian-rescue-channel
Configless setup through explicit Crestodian commands is covered by:
bash Copy code pnpm test :docker:crestodian-first-run
...
flow:
bash Copy code pnpm openclaw qa suite --scenario crestodian-ring-zero-setup
Related
CLI reference
Doctor
TUI
