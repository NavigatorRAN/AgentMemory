...
- Requested URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-guidance
- Final URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-guidance
- Canonical URL: https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-guidance
- Fetched at: 2026-06-23T14:19:54Z
- Content type: text/html; charset=utf-8

## Description

Control LLM output with regex and grammars, guarantee valid JSON/XML/code generation, enforce structured formats, and build multi-step workflows with Guidanc...
...
Skill metadata ​
Source Optional — install with hermes skills install official/mlops/guidance Path optional-skills/mlops/guidance Version 1.0.0 Author Orchestra Research License MIT Dependencies guidance , transformers Platforms linux, macos, windows Tags Prompt Engineering , Guidance , Constrained Generation , Structured Output , JSON Validation , Grammar , Microsoft Research , Format Enforcement , Multi-Step Workflows
