# Channel docking - OpenClaw

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://docs.openclaw.ai/concepts/channel-docking
- Final URL: https://docs.openclaw.ai/concepts/channel-docking
- Canonical URL: https://docs.openclaw.ai/concepts/channel-docking
- Fetched at: 2026-06-23T14:38:31Z
...
json5 Copy code { session : { identityLinks : { alice : [ "telegram:123" , "discord:456" ], }, }, }
If Alice sends this from Telegram:
text Copy code /dock_discord
OpenClaw keeps the current session context and changes the reply route:
Before docking After /dock_discord Replies go to Telegram 123 Replies go to Discord 456
...
Send /dock_discord from the Telegram session.
Keep the same OpenClaw session, but receive future replies in Discord.
Required config
Docking requires session.identityLinks . The source sender and target peer
must be in the same identity group:
json5 Copy code { session : { identityLinks : { alice : [ "telegram:123" , "discord:456" , "slack:U123" ], }, }, }
The values are channel-prefixed peer ids:
Value Meaning telegram:123 Telegram sender id 123 discord:456 Discord direct peer id 456 slack:U123 Slack user id U123
...
Target channel Command Alias Discord /dock-discord /dock_discord Mattermost /dock-mattermost /dock_mattermost Slack /dock-slack /dock_slack Telegram /dock-telegram /dock_telegram
...
Session field Example after /dock_discord lastChannel discord lastTo 456 lastAccountId the target channel account, or default
