...
- Requested URL: https://docs.openclaw.ai/gateway/discovery
- Final URL: https://docs.openclaw.ai/gateway/discovery
- Canonical URL: https://docs.openclaw.ai/gateway/discovery
- Fetched at: 2026-06-23T14:43:42Z
...
Bridge protocol ); no longer advertised for
...
Else, if discovery finds a gateway on local. or the configured wide-area domain, offer a one-tap "Use this gateway" choice and save it as the direct endpoint.
