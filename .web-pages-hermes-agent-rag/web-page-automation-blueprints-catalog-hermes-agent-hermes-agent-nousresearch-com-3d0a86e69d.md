# Automation Blueprints Catalog | Hermes Agent

Source-backed web page detail staged by AgentMemory bulk web importer.

- Requested URL: https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog
- Final URL: https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog
- Canonical URL: https://hermes-agent.nousresearch.com/docs/reference/automation-blueprints-catalog
- Fetched at: 2026-06-23T14:15:30Z
- Content type: text/html; charset=utf-8

## Description

Ready-to-run automation blueprints — set one up from the dashboard, CLI, TUI, any messenger, or the desktop app.
...
Creating Skills → Automation Blueprints for the
